...
全部 15 项公开参数、默认值和保留键见 [参数参考](/docs/pilot/kafka/param)。
...
| 查找 15 项公开参数、默认值、Schema 和保留键 | [参数参考](/docs/pilot/kafka/param) |
| 理解 `kafka.yml` 生命周期、严格滚动、轮换与集群下线 | [预置剧本](/docs/pilot/kafka/playbook) |
