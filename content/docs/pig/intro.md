...
这正是 **Pig** 诞生的初衷。Pig 由 Go 语言开发，致力于一站式管理 Postgres 及其 [464](/ext/list/) 个扩展。
...
想让你的 Postgres 如虎添翼、远离繁琐？欢迎访问 [PIG 官方文档](https://pigsty.cc/docs/pig) 获取文档、指南，并查阅庞大的 [扩展列表](/ext/list/)，
...
| `el8.x86_64`   | EL     |  8  |  8.10   | RockyLinux 8 x86  | 14-18 | 即将EOL |
| `el8.aarch64`  | EL     |  8  |  8.10   | RockyLinux 8 ARM  | 14-18 | 即将EOL |
