...
- **开箱即用的 PostgreSQL 发行版**
  ...
  Pigsty 整合了 PostgreSQL 生态中的 [**{{< param pgext_count >}} 个扩展插件**](/ext/list/)，提供开箱即用的分布式、时序、地理、空间、图、向量、搜索等多模态数据库能力。从内核到 RDS 发行版，在 EL/Debian/Ubuntu 下提供 14 - 18 版本的生产级数据库服务。
