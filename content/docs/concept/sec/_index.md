...
| 章节 | 说明 | 核心问题 |
|:---|:---|:---|
| [**纵深防御**](level/) | 七层安全模型与基线 | 安全体系整体如何落地？ |
| [**身份认证**](auth/) | HBA 规则、密码策略、证书认证 | 如何验证用户身份？ |
| [**访问控制**](ac/) | 角色系统、权限模型、数据库隔离 | 如何控制用户权限？ |
| [**加密通信**](ca/) | TLS、本地 CA、证书管理 | 如何保护传输与证书？ |
| [**数据安全**](data/) | 校验和、备份、加密与恢复 | 数据如何完整可恢复？ |
| [**合规清单**](compliance/) | 等保三级与 SOC2 对照 | 如何满足合规要求？ |
{.full-width}
