...
| [`vip_interface`](#vip_interface)         |  `string`  | `C/I` | 节点 vip 网络接口监听，默认为 auto              |
...
这些 CIDR 范围内的主机将被视为可信内网主机，享有更宽松的防火墙规则。同时，在 [**PG/PGB HBA 规则**](/docs/concept/sec/auth) 中，这里定义的内网范围也会被视作 “内网” 对待。
