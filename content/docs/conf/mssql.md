...
title: mssql
weight: 420
description: 固定使用 PostgreSQL 17 兼容 Babelfish 内核，提供 SQL Server 协议与 T-SQL 兼容能力
...
- 默认创建扩展：`uuid-ossp`、`babelfishpg_common`、`babelfishpg_tsql`、`babelfishpg_tds`、`babelfishpg_money`
