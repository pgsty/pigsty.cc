...
| 内核模版  | [`pgsql`](/docs/conf/pgsql/)、[`citus`](/docs/conf/citus/)、[`mssql`](/docs/conf/mssql/)、[`cloudberry`](/docs/conf/cloudberry/)、[`polar`](/docs/conf/polar/)、[`ivory`](/docs/conf/ivory/)、[`mysql`](/docs/conf/mysql/)、[`pgtde`](/docs/conf/pgtde/)、[`oriole`](/docs/conf/oriole/)、[`supabase`](/docs/conf/supabase/) |
