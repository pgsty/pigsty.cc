...
weight: 555
description: 使用 Pigsty 自托管企业级 supabase，带有监控，高可用，PITR，IaC 以及 555 PG 扩展。
module: [SOFTWARE]
categories: [参考]
---
...
在这一自建部署架构中，您获得了使用不同内核的自由（PostgreSQL 14-18，默认 18），加装 [**555**](/ext/list/) 个扩展的自由，扩容与伸缩 Supabase / Postgres / MinIO 的自由，
