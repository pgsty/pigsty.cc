...
- [**可扩展性**](/img/pigsty/ecosystem.png)：[**海量扩展**](/ext/list) 开箱即用：深度整合 **PostGIS**、**TimescaleDB**、**Citus**、**PGVector** 等 [**555**](/ext/list/) 插件与 [**12 款 PG 内核**](/docs/pgsql/kernel)。
...
- 开箱即用的 [PostgreSQL](https://www.postgresql.org/) 发行版，整合地理、时序、分布式、图、向量、搜索、AI 等 555 个 [扩展插件](/ext/list)。
...
PostgreSQL 的灵魂在于其丰富的 [**扩展生态**](/blog/pg/pg-eat-db-world)，而 Pigsty 独一无二地深度整合了 PostgreSQL 生态中的 [**555 扩展**](/ext/list/)，为您提供开箱即用的超融合多模态数据库！
