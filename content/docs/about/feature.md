...
- [**可扩展性**](/img/pigsty/ecosystem.png)： 强力 [**扩展**](/ext/list) 开箱即用：深度整合 **PostGIS**, **TimescaleDB**, **Citus**, **PGVector** 等 [**510**](/ext/list/) 插件与 Oracle / SQL Server 的 [**兼容内核**](/docs/pgsql/kernel)。
...
- 开箱即用的 [PostgreSQL](https://www.postgresql.org/) 发行版，深度整合地理、时序、分布式、图、向量、搜索、AI 等 510 个 [扩展插件](/ext/list)！
