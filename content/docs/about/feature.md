...
- [**可扩展性**](/img/pigsty/ecosystem.png)： 强力 [**扩展**](/ext/list) 开箱即用：深度整合 **PostGIS**, **TimescaleDB**, **Citus**, **PGVector** 等 [**451**](/ext/list/) 插件与 Oracle / SQL Server 的 [**兼容内核**](/docs/pgsql/kernel)。
...
- [丰富的扩展插件](#丰富的扩展插件)：提供无可比拟的 451 扩展，提供开箱即用的分布式的时序地理空间图文向量多模态数据库能力。
...
- 开箱即用的 [PostgreSQL](https://www.postgresql.org/) 发行版，深度整合地理、时序、分布式、图、向量、搜索、AI等 451 个 [扩展插件](/ext/list)！
...
PostgreSQL 的灵魂在于其丰富的 [**扩展生态**](/blog/pg/pg-eat-db-world)，而 Pigsty 独一无二地深度整合了 PostgreSQL 生态中的 [**451 扩展**](/ext/list/)，为您提供开箱即用的超融合多模态数据库！
