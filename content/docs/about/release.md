...
Pigsty 当前的最新稳定版本为 [**v4.2.0**](#v420)。

|       版本        |    发布日期    | 摘要                                                      |                                           发布页面                                            |
|:---------------:|:----------:|---------------------------------------------------------|:-----------------------------------------------------------------------------------------:|
| [v4.2.0](#v420) | 2026-02-27 | 例行小版本更新，六大 PG 内核集中更新                                    |               [v4.2.0](https://github.com/pgsty/pigsty/releases/tag/v4.2.0)               |
...
> 发布于 2026-02-27（与 PostgreSQL 18.3 系列号外小版本同步）
>
> `v4.1.0..v4.2.0` 共 **12 个提交**，**98 文件变更**，**+663 / -563** 行

**版本定位**

- `4.2.0` 定位为例行小版本更新，重点是上游小版本追平、包重编译与安装链路修复。
...
> 依据 [APT Changelog 2026-02-27](/docs/repo/pgsql/deb/#2026-02-27) 与 [DNF Changelog 2026-02-27](/docs/repo/pgsql/rpm/#2026-02-27) 汇总（`v4.1.0` 发布后的新增变更）。
...
> 依据 [Infra Changelog 2026-02-18](/docs/repo/infra/log/#2026-02-18)、[2026-02-22](/docs/repo/infra/log/#2026-02-22)、[2026-02-26](/docs/repo/infra/log/#2026-02-26) 汇总（`v4.1.0` 发布后的新增变更）。

| 名称                           | 旧版本            | 新版本            | 备注              |
|:-----------------------------|:---------------|:---------------|:----------------|
| `grafana`                    | 12.3.2         | 12.4.0         | 多次更新（2/18，2/26） |
...
| `loki`                       | 3.6.5          | 3.6.7          | 多次更新（2/22，2/26） |
| `promtail`                   | 3.6.5          | 3.6.7          | 多次更新（2/22，2/26） |
| `logcli`                     | 3.6.5          | 3.6.7          | 多次更新（2/22，2/26） |
| `grafana-victorialogs-ds`    | 0.24.1         | 0.26.2         | 多次更新（2/18，2/26） |
| `grafana-victoriametrics-ds` | 0.21.0         | 0.23.1         | 多次更新（2/18，2/26） |
| `grafana-infinity-ds`        | 3.7.0          | 3.7.2          | 多次更新（2/18，2/26） |
| `redis_exporter`             | 1.80.2         | 1.81.0         |                 |
| `etcd`                       | 3.6.7          | 3.6.8          |                 |
| `dblab`                      | 0.34.2         | 0.34.3         |                 |
| `tigerbeetle`                | 0.16.72        | 0.16.74        | 多次更新（2/18，2/26） |
| `seaweedfs`                  | 4.09           | 4.13           |                 |
| `rustfs`                     | 1.0.0-alpha.82 | 1.0.0-alpha.83 |                 |
| `uv`                         | 0.10.0         | 0.10.4         |                 |
| `kafka`                      | 4.1.1          | 4.2.0          |                 |
| `npgsqlrest`                 | 3.7.0          | 3.10.0         | 多次更新（2/18，2/26） |
| `postgrest`                  | 14.4           | 14.5           |                 |
| `caddy`                      | 2.10.2         | 2.11.1         |                 |
| `rclone`                     | 1.73.0         | 1.73.1         |                 |
| `pev2`                       | 1.20.1         | 1.20.2         |                 |
| `genai-toolbox`              | 0.25.0         | 0.27.0         |                 |
| `opencode`                   | 1.1.59         | 1.2.15         | 多次更新（2/18，2/22，2/26） |
| `claude`                     | 2.1.37         | 2.1.59         | 多次更新（2/18，2/26） |
| `codex`                      | 0.104.0        | 0.105.0        |                 |
| `code`                       | 1.109.2        | 1.109.4        |                 |
| `code-server`                | 4.108.2        | 4.109.2        |                 |
| `nodejs`                     | 24.13.1        | 24.14.0        |                 |
| `pig`                        | 1.1.2          | 1.3.0          | 多次更新（2/22，2/26） |
| `stalwart`                   | -              | 0.15.5         | 新增              |
| `maddy`                      | -              | 0.8.2          | 新增              |

**提交清单（`v4.1.0..v4.2.0`，共 12，2026-02-15 ~ 2026-02-23）**
...
- pg_timetable 5.13.0
- ferretdb 2.2.0
- documentdb [0.103.0](https://github.com/FerretDB/documentdb/releases/tag/v0.103.0-ferretdb-2.2.0) (新增 aarch64支持)
...
- [Dify](/docs/app/dify)： AI智能体工作流编排与 LLMOps，使用 PostgreSQL 作为元数据库，PGVector 作为向量存储。
