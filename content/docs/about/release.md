...
Pigsty 当前的最新稳定版本为 [**v4.0.0-c1**](#v400-c1)，正式版本预估于 2026-01-31 前发布。

|          版本           |    发布日期    | 摘要                                                      |                                           发布页面                                            |
|:---------------------:|:----------:|---------------------------------------------------------|:-----------------------------------------------------------------------------------------:|
| [v4.0.0-c1](#v400-c1) | 2026-01-07 | Infra 重构，安全加固，快速克隆，Agent 能力                             |             [v4.0.0](https://github.com/pgsty/pigsty/releases/tag/v4.0.0-c1)              |
