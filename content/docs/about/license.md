...
|  MINIO   |               [Silo](https://github.com/pgsty/silo)               | [AGPLv3](https://github.com/pgsty/silo/blob/main/LICENSE)                                                 | 当前源码默认的 S3 兼容对象存储服务              |   可选   |
|  MINIO   |              [MinIO](https://github.com/pgsty/minio)              | [AGPLv3](https://github.com/pgsty/minio/blob/master/LICENSE)                                              | 兼容已有 MinIO 部署                    |   可选   |
|  MINIO   |            [RustFS](https://github.com/rustfs/rustfs)             | [Apache License 2.0](https://github.com/rustfs/rustfs/blob/main/LICENSE)                                  | 可选的 S3 兼容对象存储后端                  |   可选   |
