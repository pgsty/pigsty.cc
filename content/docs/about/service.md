...
针对开源版本，我们提供 PostgreSQL 18 在七个主流操作系统发行版当前小版本上的预制标准离线软件包：EL 9.8 / 10.2、Debian 12.13 / 13.4、Ubuntu 26.04.0 / 24.04.4 / 22.04.5，并提供 `x86_64` 与 `aarch64` 构建。
...
- **扩展支持能力**：针对 510 个可用 PG Extension，提供 PG 14-18 在主流操作系统上开箱即用的安装能力。
- **完整功能模块**：提供所有功能模块：
