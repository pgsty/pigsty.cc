...
- [**`PGSQL`**](/docs/pgsql)：带有高可用，时间点恢复，IaC，SOP，监控系统，以及 [**531**](/ext/list/) 个扩展插件的自治的 PostgreSQL 集群。
...
- [**`KAFKA`**](/docs/pilot/kafka)、[**`KUBE`**](/docs/pilot/kube/)、[**`VICTORIA`**](/blog/db/victoria-stack/)、[**`JUPYTER`**](/docs/app/jupyter/)：试点模块，当前不对外开放使用。
