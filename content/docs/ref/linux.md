...
Pigsty 推荐使用的操作系统版本：RockyLinux 10.2 / 9.8、Ubuntu 26.04.0 / 24.04.4 / 22.04.5、Debian 13.5 / 12.14。
...
{{% alert title="推荐使用 RockyLinux 10.2 与 9.8" color="success" %}}
...
建议离线安装包/自建离线仓库与系统 **EL 小版本**（例如 RockyLinux 9.8 / 10.2）保持一致，跨小版本可能因 OpenSSL 等依赖版本跳变导致不可用。
{{% /alert %}}
...
| AlmaLinux 10.2 | [`cloud-image/almalinux-10`](https://portal.cloud.hashicorp.com/vagrant/discover/cloud-image/almalinux-10) |
