...
Pigsty 扩展包数据同步自 `~/pgsty/pgext/content/list/pkg.zh.md`，完整信息请见 [**PGEXT.CLOUD**](https://pgext.cloud/zh/list/)。

当前共有 **444** 个可用 PostgreSQL 扩展，划入 372 个 Package 中。

### TIME

| 扩展版名称 | 版本号 | 分类 | 说明 |
|:---|:---|:---:|:---|
| [timescaledb](https://pgext.cloud/zh/e/timescaledb/) | `2.24.0` | `TIME` | 时序数据库扩展插件 |
| [timescaledb_toolkit](https://pgext.cloud/zh/e/timescaledb_toolkit/) | `1.22.0` | `TIME` | 超表分析查询，时间序列流式处理，以及其他SQL工具 |
| [pg_timeseries](https://pgext.cloud/zh/e/timeseries/) | `0.2.0` | `TIME` | 时序数据API封装 |
...
| [pg_background](https://pgext.cloud/zh/e/pg_background/) | `1.5` | `TIME` | 在后台运行 SQL 查询 |

### GIS

| 扩展版名称 | 版本号 | 分类 | 说明 |
|:---|:---|:---:|:---|
| [postgis](https://pgext.cloud/zh/e/postgis/) | `3.6.1` | `GIS` | PostGIS 几何和地理空间扩展 |
| [pgrouting](https://pgext.cloud/zh/e/pgrouting/) | `3.8.0` | `GIS` | 提供寻路能力 |
| [pointcloud](https://pgext.cloud/zh/e/pointcloud/) | `1.2.5` | `GIS` | 提供激光雷达点云数据类型支持 |
| [pg_h3](https://pgext.cloud/zh/e/h3/) | `4.2.3` | `GIS` | H3六边形层级索引支持 |
...
| [pg_tzf](https://pgext.cloud/zh/e/tzf/) | `0.2.3` | `GIS` | 快速根据GPS经纬度坐标查找时区 |
...
| 扩展版名称 | 版本号 | 分类 | 说明 |
|:---|:---|:---:|:---|
| [pgvector](https://pgext.cloud/zh/e/vector/) | `0.8.1` | `RAG` | 向量数据类型和 ivfflat / hnsw 访问方法 |
| [vchord](https://pgext.cloud/zh/e/vchord/) | `1.0.0` | `RAG` | 使用Rust重写的高性能向量扩展 |
| [pgvectorscale](https://pgext.cloud/zh/e/vectorscale/) | `0.9.0` | `RAG` | 使用DiskANN算法对向量进行高效索引 |
| [pg_vectorize](https://pgext.cloud/zh/e/vectorize/) | `0.26.0` | `RAG` | 在PostgreSQL中封装RAG向量检索服务 |
...
| 扩展版名称 | 版本号 | 分类 | 说明 |
|:---|:---|:---:|:---|
| [pg_search](https://pgext.cloud/zh/e/pg_search/) | `0.21.4` | `FTS` | ParadeDB BM25算法全文检索插件，ES全文检索 |
...
| [pg_biscuit](https://pgext.cloud/zh/e/biscuit/) | `2.2.2` | `FTS` | 使用IAM的高性能文本模式匹配 |
| [pg_textsearch](https://pgext.cloud/zh/e/pg_textsearch/) | `0.4.0` | `FTS` | 带有BM25排序的全文搜索扩展 |
...
| [hydra](https://pgext.cloud/zh/e/columnar/) | `1.1.2` | `OLAP` | 开源列式存储扩展 |
...
| [pg_partman](https://pgext.cloud/zh/e/pg_partman/) | `5.4.0` | `OLAP` | 用于按时间或 ID 管理分区表的扩展 |
| [plproxy](https://pgext.cloud/zh/e/plproxy/) | `2.11.0` | `OLAP` | 作为过程语言实现的数据库分区 |
| [pg_strom](https://pgext.cloud/zh/e/pg_strom/) | `6.0` | `OLAP` | 使用GPU与NVMe加速大数据处理 |
...
| 扩展版名称 | 版本号 | 分类 | 说明 |
|:---|:---|:---:|:---|
| [age](https://pgext.cloud/zh/e/age/) | `1.6.0` | `FEAT` | Apache AGE，图数据库扩展 （Deb可用） |
...
| [pg_jsonschema](https://pgext.cloud/zh/e/pg_jsonschema/) | `0.3.3` | `FEAT` | 提供JSON Schema校验能力 |
...
| [pg_plan_filter](https://pgext.cloud/zh/e/plan_filter/) | `0.0.1` | `FEAT` | 使用执行计划代价过滤阻止特定查询语句 |
...
| [pg_incremental](https://pgext.cloud/zh/e/pg_incremental/) | `1.2.0` | `FEAT` | 增量处理流式事件 |
| [pgmq](https://pgext.cloud/zh/e/pgmq/) | `1.9.0` | `FEAT` | 基于Postgres实现类似AWS SQS/RSMQ的消息队列 |
...
| [omnigres](https://pgext.cloud/zh/e/omni/) | `0.2.14` | `FEAT` | PostgreSQL即平台，Omnigres主扩展与加载器 |
...
| [pljs](https://pgext.cloud/zh/e/pljs/) | `1.0.4` | `LANG` | PL/JS 可信过程程序语言 |
| [pllua](https://pgext.cloud/zh/e/pllua/) | `2.0.12` | `LANG` | Lua 程序语言 |
| [plprql](https://pgext.cloud/zh/e/plprql/) | `18.0.0` | `LANG` | 在PostgreSQL使用PRQL——管线式关系查询语言 |
| [pldebugger](https://pgext.cloud/zh/e/pldbgapi/) | `1.9` | `LANG` | 用于调试 PL/pgSQL 函数的服务器端支持 |
| [plpgsql_check](https://pgext.cloud/zh/e/plpgsql_check/) | `2.8.5` | `LANG` | 对 plpgsql 函数进行扩展检查 |
...
| 扩展版名称 | 版本号 | 分类 | 说明 |
|:---|:---|:---:|:---|
| [pg_prefix](https://pgext.cloud/zh/e/prefix/) | `1.2.10` | `TYPE` | 前缀树数据类型 |
| [pg_semver](https://pgext.cloud/zh/e/semver/) | `0.41.0` | `TYPE` | 语义版本号数据类型 |
| [pgunit](https://pgext.cloud/zh/e/unit/) | `7.10` | `TYPE` | SI 国标单位扩展 |
...
| [pg_roaringbitmap](https://pgext.cloud/zh/e/roaringbitmap/) | `1.1.0` | `TYPE` | 支持RoaringBitmap数据类型 |
| [pgfaceting](https://pgext.cloud/zh/e/pgfaceting/) | `0.2.0` | `TYPE` | 使用倒排索引的高速切面查询 |
| [pgsphere](https://pgext.cloud/zh/e/pg_sphere/) | `1.5.2` | `TYPE` | 球面对象函数、运算符与索引支持 |
| [pg_country](https://pgext.cloud/zh/e/country/) | `0.0.3` | `TYPE` | 国家代码数据类型，遵循ISO 3166-1标准 |
| [pg_xenophile](https://pgext.cloud/zh/e/pg_xenophile/) | `0.8.3` | `TYPE` | PostgreSQL i8n与l10n工具包 |
| [pg_currency](https://pgext.cloud/zh/e/currency/) | `0.0.3` | `TYPE` | 使用1字节表示的货币数据类型 |
| [pgcollection](https://pgext.cloud/zh/e/collection/) | `1.1.0` | `TYPE` | 在PlPGSQL中使用的内存优化高性能集合数据结构 |
...
| [pguint](https://pgext.cloud/zh/e/uint/) | `1.20250815` | `TYPE` | 无符号整型数据类型 |
| [pg_uint128](https://pgext.cloud/zh/e/uint128/) | `1.1.1` | `TYPE` | 原生128位无符号整型数据类型 |
...
| [pg_uri](https://pgext.cloud/zh/e/uri/) | `1.20151224` | `TYPE` | URI数据类型 |
| [pg_emailaddr](https://pgext.cloud/zh/e/emailaddr/) | `0` | `TYPE` | Email地址数据类型 |
| [pg_acl](https://pgext.cloud/zh/e/acl/) | `1.0.4` | `TYPE` | ACL数据类型 |
...
| 扩展版名称 | 版本号 | 分类 | 说明 |
|:---|:---|:---:|:---|
| [pg_gzip](https://pgext.cloud/zh/e/gzip/) | `1.0.0` | `UTIL` | 使用SQL执行Gzip压缩与解压缩 |
| [pg_bzip](https://pgext.cloud/zh/e/bzip/) | `1.0.0` | `UTIL` | BZIP压缩解压缩函数包 |
| [pg_zstd](https://pgext.cloud/zh/e/zstd/) | `1.1.2` | `UTIL` | ZSTD压缩解压缩函数包 |
| [pg_http](https://pgext.cloud/zh/e/http/) | `1.7.0` | `UTIL` | HTTP客户端，允许在数据库内收发HTTP请求 (supabase) |
| [pg_net](https://pgext.cloud/zh/e/pg_net/) | `0.20.0` | `UTIL` | 用 SQL 进行异步非阻塞HTTP/HTTPS 请求的扩展 (supabase) |
...
| [pg_envvar](https://pgext.cloud/zh/e/envvar/) | `1.0.1` | `UTIL` | 获取环境变量的函数 |
...
| [pg_schedoc](https://pgext.cloud/zh/e/schedoc/) | `0.0.1` | `UTIL` | 在Django与DBT之间通过注释文档交换元数据 |
| [pg_hashlib](https://pgext.cloud/zh/e/hashlib/) | `1.1` | `UTIL` | 稳定哈希函数包 |
| [pg_xxhash](https://pgext.cloud/zh/e/xxhash/) | `0.0.1` | `UTIL` | xxhash哈希函数包 |
...
| [pg_ecdsa](https://pgext.cloud/zh/e/pguecc/) | `1.0` | `UTIL` | PostgreSQL的uECC绑定，椭圆曲线加解密函数包 |
| [pgsparql](https://pgext.cloud/zh/e/sparql/) | `1.0` | `UTIL` | 使用SQL查询SPARQL数据源 |
...
| [pg_typeid](https://pgext.cloud/zh/e/typeid/) | `0.3.0` | `FUNC` | PG原生TypeID类型与函数 |
...
| [pgxicor](https://pgext.cloud/zh/e/xicor/) | `0.1.0` | `FUNC` | 在PG中计算XI相关系数 |
| [pg_weighted_statistics](https://pgext.cloud/zh/e/weighted_statistics/) | `1.0.0` | `FUNC` | 针对稀疏数据的高性能加权统计量计算 |
...
| [pg_arraymath](https://pgext.cloud/zh/e/arraymath/) | `1.1` | `FUNC` | 数组逐元素数学运算符包 |
| [pg_math](https://pgext.cloud/zh/e/pg_math/) | `1.0` | `FUNC` | 使用GSL库的数学统计函数 |
| [pg_random](https://pgext.cloud/zh/e/random/) | `2.0.0` | `FUNC` | 随机数生成器 |
| [pg_base36](https://pgext.cloud/zh/e/base36/) | `1.0.0` | `FUNC` | Base36编码解码扩展 |
| [pg_base62](https://pgext.cloud/zh/e/base62/) | `0.0.1` | `FUNC` | Base62编码解码扩展 |
| [pg_base58](https://pgext.cloud/zh/e/pg_base58/) | `0.0.1` | `FUNC` | Base58 编码/解码函数 |
| [pg_financial](https://pgext.cloud/zh/e/financial/) | `1.0.1` | `FUNC` | 金融领域聚合函数 |
| [pg_convert](https://pgext.cloud/zh/e/convert/) | `0.1.0` | `FUNC` | 用于空间里程等的公英制转换函数 |
...
| [pg_ddlx](https://pgext.cloud/zh/e/ddlx/) | `0.30` | `ADMIN` | 提取数据库对象的DDL |
| [pglinter](https://pgext.cloud/zh/e/pglinter/) | `1.0.1` | `ADMIN` | PG数据库规则检查插件 |
| [pg_prioritize](https://pgext.cloud/zh/e/prioritize/) | `1.0.4` | `ADMIN` | 获取和设置 PostgreSQL 后端的优先级 |
| [pg_checksums](https://pgext.cloud/zh/e/pg_checksums/) | `1.3` | `ADMIN` | 在离线模式下激活/启用/禁用数据库集群的校验和功能 |
| [pg_readonly](https://pgext.cloud/zh/e/pg_readonly/) | `1.0.3` | `ADMIN` | 将集群设置为只读 |
...
| [preprepare](https://pgext.cloud/zh/e/pre_prepare/) | `0.9` | `ADMIN` | 在服务端预先准备好PreparedStatement备用 |
...
| [pg_fio](https://pgext.cloud/zh/e/fio/) | `1.0` | `ADMIN` | PostgreSQL文件IO函数包 |
...
| [pgpool](https://pgext.cloud/zh/e/pgpool_adm/) | `4.7.0` | `ADMIN` | PGPool 管理函数 |
...
| [pgsentinel](https://pgext.cloud/zh/e/pgsentinel/) | `1.3.1` | `STAT` | 活跃会话历史 |
| [system_stats](https://pgext.cloud/zh/e/system_stats/) | `3.2` | `STAT` | PostgreSQL 的系统统计函数 |
| [pg_meta](https://pgext.cloud/zh/e/meta/) | `0.4.0` | `STAT` | 标准化，更友好的PostgreSQL系统目录视图 |
...
| [pg_explain_ui](https://pgext.cloud/zh/e/explain_ui/) | `0.0.2` | `STAT` | 快速跳转至PEV查阅可视化执行计划 |
...
| [supautils](https://pgext.cloud/zh/e/supautils/) | `3.0.2` | `SEC` | 用于在云环境中确保数据库集群的安全 |
| [pgsodium](https://pgext.cloud/zh/e/pgsodium/) | `3.1.9` | `SEC` | 表数据加密存储 TDE |
| [pg_vault](https://pgext.cloud/zh/e/supabase_vault/) | `0.3.1` | `SEC` | 在 Vault 中存储加密凭证的扩展 (supabase) |
| [pg_session_jwt](https://pgext.cloud/zh/e/pg_session_jwt/) | `0.4.0` | `SEC` | 使用JWT进行会话认证 |
| [pg_anon](https://pgext.cloud/zh/e/anon/) | `2.5.1` | `SEC` | 数据匿名化处理工具 |
...
| [credcheck](https://pgext.cloud/zh/e/credcheck/) | `4.4` | `SEC` | 明文凭证检查器 |
...
| [pg_noset](https://pgext.cloud/zh/e/noset/) | `0.3.0` | `SEC` | 阻止非超级用户使用SET/RESET设置变量 |
...
| [db2_fdw](https://pgext.cloud/zh/e/db2_fdw/) | `18.0.1` | `FDW` | 提供对DB2的外部数据源包装器 |
...
| [pg_redis_pubsub](https://pgext.cloud/zh/e/redis/) | `0.0.1` | `FDW` | 从PG向Redis发送Pub/Sub消息 |
