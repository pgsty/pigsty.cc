...
| 扩展版名称 | 版本号 | 分类 | 说明 |
|:---|:---|:---:|:---|
| [timescaledb](https://pgext.cloud/zh/e/timescaledb/) | `2.25.2` | `TIME` | 时序数据库扩展插件 |
...
| [pg_background](https://pgext.cloud/zh/e/pg_background/) | `1.8` | `TIME` | 在后台运行 SQL 查询 |
...
| [q3c](https://pgext.cloud/zh/e/q3c/) | `2.0.2` | `GIS` | Q3C天空索引插件 |
...
| [pg_eviltransform](https://pgext.cloud/zh/e/pg_eviltransform/) | `0.0.2` | `GIS` | 基于PostGIS ST_Transform 的 BD09/GCJ02 坐标转换扩展 |
...
| 扩展版名称 | 版本号 | 分类 | 说明 |
|:---|:---|:---:|:---|
| [vector](https://pgext.cloud/zh/e/vector/) | `0.8.2` | `RAG` | 向量数据类型和 ivfflat / hnsw 访问方法 |
| [vchord](https://pgext.cloud/zh/e/vchord/) | `1.1.1` | `RAG` | 使用Rust重写的高性能向量扩展 |
...
| 扩展版名称 | 版本号 | 分类 | 说明 |
|:---|:---|:---:|:---|
| [pg_search](https://pgext.cloud/zh/e/pg_search/) | `0.21.12` | `FTS` | ParadeDB BM25算法全文检索插件，ES全文检索 |
...
| [pg_pinyin](https://pgext.cloud/zh/e/pg_pinyin/) | `0.0.2` | `FTS` | PostgreSQL 拼音转写与检索辅助扩展 |
...
| [pg_clickhouse](https://pgext.cloud/zh/e/pg_clickhouse/) | `0.1.4` | `OLAP` | 从PostgreSQL中查询ClickHouse的接口 |
...
| [pg_partman](https://pgext.cloud/zh/e/pg_partman/) | `5.4.2` | `OLAP` | 用于按时间或 ID 管理分区表的扩展 |
...
| [pgmq](https://pgext.cloud/zh/e/pgmq/) | `1.11.0` | `FEAT` | 基于Postgres实现类似AWS SQS/RSMQ的消息队列 |
| [pgq](https://pgext.cloud/zh/e/pgq/) | `3.5.1` | `FEAT` | 通用队列的PG实现 |
| [orioledb](https://pgext.cloud/zh/e/orioledb/) | `1.6` | `FEAT` | OrioleDB，下一代事务处理引擎 |
...
| [plpgsql_check](https://pgext.cloud/zh/e/plpgsql_check/) | `2.8.11` | `LANG` | 对 plpgsql 函数进行扩展检查 |
...
| [snowflake](https://pgext.cloud/zh/e/snowflake/) | `2.4` | `FUNC` | Snowflake 风格 64 位 ID 生成与序列工具 |
...
| [aggs_for_vecs](https://pgext.cloud/zh/e/aggs_for_vecs/) | `1.4.1` | `FUNC` | 针对数组类型的聚合函数集合扩展 |
...
| [pg_rewrite](https://pgext.cloud/zh/e/pg_rewrite/) | `2.1.0` | `ADMIN` | 在线重写整表，不阻塞读写 |
...
| [pglinter](https://pgext.cloud/zh/e/pglinter/) | `1.1.1` | `ADMIN` | PG数据库规则检查插件 |
...
| [qos](https://pgext.cloud/zh/e/qos/) | `1.0` | `ADMIN` | PostgreSQL QoS 资源治理扩展（会话与查询限流/隔离） |
...
| [pgpool_adm](https://pgext.cloud/zh/e/pgpool_adm/) | `4.7.1` | `ADMIN` | PGPool 管理函数 |
| [pgpool_recovery](https://pgext.cloud/zh/e/pgpool_recovery/) | `4.7.1` | `ADMIN` | PGPool辅助扩展，从v4.3提供的恢复函数 |
| [pgpool_regclass](https://pgext.cloud/zh/e/pgpool_regclass/) | `4.7.1` | `ADMIN` | PGPool辅助扩展，RegClass替代 |
...
| [pg_stat_monitor](https://pgext.cloud/zh/e/pg_stat_monitor/) | `2.3.2` | `STAT` | 提供查询聚合统计、客户端信息、执行计划详细信息和直方图 |
...
| [pgauditlogtofile](https://pgext.cloud/zh/e/pgauditlogtofile/) | `1.8.0` | `SEC` | pgAudit 子扩展，将审计日志写入单独的文件中 |
...
| [credcheck](https://pgext.cloud/zh/e/credcheck/) | `4.6` | `SEC` | 明文凭证检查器 |
...
| [pg_tde](https://pgext.cloud/zh/e/pg_tde/) | `2.1` | `SEC` | Percona加密存储引擎 |
...
| [orafce](https://pgext.cloud/zh/e/orafce/) | `4.16.4` | `SIM` | 模拟 Oracle RDBMS 的一部分函数和包的函数和运算符 |
...
| [ivorysql_ora](https://pgext.cloud/zh/e/ivorysql_ora/) | `1.0` | `SIM` | Oracle 兼容扩展 |
| [ora_btree_gin](https://pgext.cloud/zh/e/ora_btree_gin/) | `1.0` | `SIM` | Oracle 数据类型 GIN 索引支持 |
| [ora_btree_gist](https://pgext.cloud/zh/e/ora_btree_gist/) | `1.0` | `SIM` | Oracle 数据类型 GiST 索引支持 |
| [pg_get_functiondef](https://pgext.cloud/zh/e/pg_get_functiondef/) | `1.0` | `SIM` | 获取函数定义 |
| [plisql](https://pgext.cloud/zh/e/plisql/) | `1.0` | `SIM` | PL/iSQL 过程语言 |
| [gb18030_2022](https://pgext.cloud/zh/e/gb18030_2022/) | `1.0` | `SIM` | 支持 GB18030-2022 与 UTF-8 编码转换 |
...
| [babelfishpg_common](https://pgext.cloud/zh/e/babelfishpg_common/) | `5.5.0` | `SIM` | SQL Server 数据类型兼容扩展 |
| [babelfishpg_tsql](https://pgext.cloud/zh/e/babelfishpg_tsql/) | `5.5.0` | `SIM` | SQL Server SQL语法兼容性扩展 |
...
| [aux_mysql](https://pgext.cloud/zh/e/aux_mysql/) | `1.5` | `SIM` | MySQL兼容辅助扩展模块 |
...
| [spock](https://pgext.cloud/zh/e/spock/) | `5.0.5` | `ETL` | PostgreSQL 多主逻辑复制扩展 |
| [lolor](https://pgext.cloud/zh/e/lolor/) | `1.2.2` | `ETL` | 让 PostgreSQL 大对象兼容逻辑复制的扩展 |
...
| [decoderbufs](https://pgext.cloud/zh/e/decoderbufs/) | `3.4.1` | `ETL` | 将WAL逻辑解码为ProtocolBuffer协议的消息 |
