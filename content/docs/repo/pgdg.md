...
```yaml
- { name: pgdg           ,description: 'PGDG'               ,module: pgsql   ,releases: [11,12,13,22,24,26] ,arch: [x86_64, aarch64] ,baseurl: { default: 'http://apt.postgresql.org/pub/repos/apt/ ${distro_codename}-pgdg main'            ,china: 'https://repo.pigsty.cc/apt/pgdg/ ${distro_codename}-pgdg main' }}
...
|  el8.x86_64  | EL     |  8  | **18** **17** **16** **15** **14** | 即将 EOL |
| el8.aarch64  | EL     |  8  | **18** **17** **16** **15** **14** | 即将 EOL |
