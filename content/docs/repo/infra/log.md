...
| 名称                        | 旧值                                       | 新值                   | 备注                                      |
|:--------------------------|:------------------------------------------|:---------------------|:----------------------------------------|
| `claude`                  | 2.1.241                                   | 2.1.252              | 通过代理下载并按官方清单核验，已构建双架构 RPM/DEB       |
| `cloudflared`             | 2026.8.2                                  | 2026.8.3             | 已核验裸二进制并重打包双架构 RPM/DEB                |
| `code`                    | 1.134.0                                   | 1.135.0              | 官方原生 DEB/RPM 保持逐字节不变                    |
| `code-server`             | 4.133.0                                   | 4.135.0              | 官方原生 DEB/RPM 已固定校验和                     |
| `codex`                   | 0.149.0                                   | 0.152.0              | 稳定标签 `rust-v0.152.0`，已构建双架构 RPM/DEB   |
| `crush`                   | 0.91.0                                    | 0.92.0               | 官方 tarball 重打包并保留许可证文件                |
| `dblab`                   | 0.48.1                                    | 0.49.0               | 已核验上游制品并构建双架构 RPM/DEB                 |
| `k3s`                     | 1.36.3                                    | 1.36.4               | 上游 `v1.36.4+k3s1`，已构建双架构 RPM/DEB      |
| `k3s-images`              | 1.36.3                                    | 1.36.4               | 已构建精确匹配的双架构 air-gap 镜像包                |
| `logcli`                  | 3.7.6                                     | 3.7.7                | 已构建双架构 RPM/DEB                           |
| `loki`                    | 3.7.6                                     | 3.7.7                | 已构建双架构 RPM/DEB                           |
| `loki-canary`             | 3.7.6                                     | 3.7.7                | 已构建双架构 RPM/DEB                           |
| `mcli`                    | 20260806000000.0.0                        | 20260901000000.0.0   | pgsty 分支发布制品重打包为 `1PGSTY` RPM/DEB       |
| `mtail`                   | 3.4.9                                     | 3.4.10               | 已构建双架构 RPM/DEB                           |
| `nodejs`                  | 24.19.0                                   | 24.20.0              | 已核验 Node.js 24 LTS 归档并重建                 |
| `opencode`                | 1.18.21                                   | 1.18.25              | 已构建双架构 RPM/DEB                           |
| `pg-hardstorage`          | 1.2.4                                     | 1.3.4                | 已核验静态二进制并重打包为 `1PGSTY` RPM/DEB        |
| `pg-timetable`            | 7.0.0                                     | 7.1.0                | 已构建双架构 RPM/DEB                           |
| `pgschema`                | 1.12.4                                    | 1.12.5               | 已核验裸二进制并重打包为 `1PGSTY` RPM/DEB         |
| `rainfrog`                | 0.4.4                                     | 0.4.5                | 已构建双架构 RPM/DEB                           |
| `redis-exporter`          | 1.89.0                                    | 1.90.0               | 已构建双架构 RPM/DEB                           |
| `rustfs`                  | 1.0.0-rc.3                                | 1.0.0-rc.4           | 最新非 preview 预发布版，包版本为 `1.0.0~rc4`      |
| `seaweedfs`               | 4.44                                      | 4.45                 | 已构建双架构 RPM/DEB                           |
| `sow`                     | 0.3.0                                     | 0.4.0                | 已构建双架构 RPM/DEB                           |
| `sql-studio`              | 0.1.51                                    | 0.1.53               | 已构建双架构 RPM/DEB                           |
| `stalwart`                | 0.16.18                                   | 0.16.20              | 已构建双架构 RPM/DEB                           |
| `tailcat`                 | 0.0.0-20260830010511-7c2a6ea60429        | 0.4.0                | 官方发布 tarball 替代固定源码快照                 |
| `uv`                      | 0.12.5                                    | 0.12.8               | 已构建双架构 RPM/DEB                           |
| `vector`                  | 0.57.0                                    | 0.58.0               | 官方原生 DEB/RPM 保持逐字节不变                    |
| `victoria-metrics`        | 1.150.0                                   | 1.151.0              | 已构建单机、集群与 vmutils 双架构软件包              |
{.stretch-last}
...
| 名称        | 旧值 | 新值                                        | 备注                                               |
|:----------|:---|:------------------------------------------|:-------------------------------------------------|
| `tailcat` | -  | 0.0.0-20260830010511-7c2a6ea60429        | 上游尚无标签；固定源码提交与离线 vendor，已构建双架构静态 RPM/DEB |
{.stretch-last}
...
| 名称                    | 旧值      | 新值      | 备注                            |
|:----------------------|:--------|:--------|:------------------------------|
| `claude`              | 2.1.226 | 2.1.227 | 通过代理下载并按官方清单核验，已构建双架构 RPM/DEB |
| `code-server`         | 4.131.0 | 4.132.0 | 官方双架构 RPM/DEB 已下载并核验          |
| `grafana-infinity-ds` | 3.11.2  | 3.11.3  | 已构建双架构 RPM/DEB                |
...
| `stalwart`            | 0.16.16 | 0.16.17 | 已构建双架构 RPM/DEB                |
{.stretch-last}
...
| `crush`     | 0.88.0    | 0.88.1    | 由官方 tarball 合规重打包为 `1PGSTY`，内含许可证     |
...
| 名称                        | 旧值                   | 新值             | 备注                                   |
|:--------------------------|:---------------------|:---------------|:-------------------------------------|
| `claude`                  | 2.1.222              | 2.1.223        | 通过代理下载并按官方清单核验，已构建                   |
| `codex`                   | 0.146.0              | 0.146.1        | 稳定发布标签 `rust-v0.146.1`，已构建           |
| `code`                    | 1.131.0              | 1.132.0        | 官方双架构 RPM/DEB 已下载并核验                 |
| `dblab`                   | 0.47.2               | 0.47.4         | 已构建双架构 RPM/DEB                       |
| `grafana-infinity-ds`     | 3.11.1               | 3.11.2         | 已构建双架构 RPM/DEB                       |
| `grafana-victorialogs-ds` | 0.30.1               | 0.31.0         | 已构建双架构 RPM/DEB                       |
| `k3s`                     | 1.36.2               | 1.36.3         | 官方稳定通道 `v1.36.3+k3s1`，已构建            |
| `k3s-images`              | 1.36.2               | 1.36.3         | 与 k3s 精确匹配的双架构离线镜像包，已构建              |
| `mcli`                    | 20260804000000       | 20260806000000 | pgsty 分支官方双架构 RPM/DEB 已下载并核验         |
| `opencode`                | 1.18.13              | 1.18.14        | 已构建双架构 RPM/DEB                       |
| `pgschema`                | 1.12.1               | 1.12.2         | 官方双架构 RPM/DEB 已下载并核验                 |
| `seaweedfs`               | 4.40                 | 4.41           | 已构建双架构 RPM/DEB                       |
| `silo`                    | minio 20260804000000 | 20260806000000 | 正式替换 minio；官方双架构 RPM/DEB 已核验         |
| `uv`                      | 0.12.1               | 0.12.2         | 已构建双架构 RPM/DEB                       |
| `victoria-metrics`        | 1.148.0              | 1.149.0        | 主包、cluster 与 vmutils 均已构建双架构 RPM/DEB |
{.stretch-last}

本轮同时按当前版本 `2.7.0` 重新构建了 `ferretdb2` 双架构 RPM/DEB。`silo` 已正式替换 `minio`，并与 `mcli` 一并纳入 Infra 仓库。
...
| 名称                    | 旧值             | 新值             | 备注                      |
|:----------------------|:---------------|:---------------|:------------------------|
| `agentsview`          | 0.39.0         | 0.40.1         | 已构建双架构 RPM/DEB          |
| `claude`              | 2.1.220        | 2.1.222        | 通过代理下载并按官方清单核验，已构建      |
| `code-server`         | 4.130.0        | 4.131.0        | 官方成品已下载并核验              |
| `crush`               | 0.87.0         | 0.88.0         | 仅更新官方链接；再分发仍受许可证条款阻塞    |
| `grafana`             | 13.1.1         | 13.1.2         | 官方成品已下载并核验；含安全修复        |
| `juicefs`             | 1.4.0          | 1.4.1          | 已构建双架构 RPM/DEB          |
| `mcli`                | 20260417000000 | 20260804000000 | pgsty 分支官方成品已下载并核验      |
| `minio`               | 20260618000000 | 20260804000000 | pgsty 分支官方成品已下载并核验      |
| `mongodb-exporter`    | 0.51.0         | 0.52.0         | 已构建双架构 RPM/DEB          |
| `mtail`               | 3.0.8          | 3.4.6          | 已构建双架构 RPM/DEB          |
| `nodejs`              | 24.18.1        | 24.19.0        | Node.js 24.x LTS；已构建    |
| `opencode`            | 1.18.9         | 1.18.13        | 已构建双架构 RPM/DEB          |
| `pg-hardstorage`      | 1.0.17         | 1.1.1          | 官方成品已下载并核验              |
| `pgbackrest-exporter` | 0.23.0         | 0.24.0         | 已构建双架构 RPM/DEB          |
| `pgstream`            | 1.2.5          | 1.3.1          | 已构建双架构 RPM/DEB          |
| `rclone`              | 1.74.4         | 1.75.0         | 官方成品已下载并核验              |
| `rustfs`              | 1.0.0-b11      | 1.0.0-b12      | Beta 版本线；已构建双架构 RPM/DEB |
| `stalwart`            | 0.16.15        | 0.16.16        | 已构建双架构 RPM/DEB          |
| `uv`                  | 0.12.0         | 0.12.1         | 已构建双架构 RPM/DEB          |
| `vray`                | 5.51.2         | 5.52.0         | 最新稳定版；已构建双架构 RPM/DEB    |
| `xray`                | 26.3.27        | 26.7.28        | 最新日期版本；已构建双架构 RPM/DEB   |
| `prometheus`          | 3.13.1         | 3.13.2         | 安全与稳定性修复                |
| `pig`                 | 1.6.0          | 1.6.1          | 扩展目录刷新                  |
{.stretch-last}
...
| `codex`           | 0.145.0       | 0.146.0       | 发布标签 `rust-v0.146.0`           |
| `crush`           | 0.86.0        | 0.87.0        |                                |
| `dblab`           | 0.46.0        | 0.47.2        |                                |
| `etcd`            | 3.7.0         | 3.7.1         |                                |
| `genai-toolbox`   | 1.7.0         | 1.8.0         | 源码构建；已验证 Rocky 8/9 与 Debian 12 |
| `headscale`       | 0.29.2        | 0.29.3        |                                |
| `nodejs`          | 24.18.0       | 24.18.1       | 安全更新                           |
| `opencode`        | 1.18.4        | 1.18.9        |                                |
| `pg-exporter`     | 1.4.0         | 1.4.1         | 官方发布成品                         |
...
| `rustfs`          | 1.0.0-beta.10 | 1.0.0-beta.11 | 排除 preview 版本                  |
