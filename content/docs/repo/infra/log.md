...
| `claude`            | 2.1.218  | 2.1.220  | 通过 8118 代理下载并按官方清单核验              |
| `dblab`             | 0.46.0   | 0.47.0   |                                     |
| `opencode`          | 1.18.4   | 1.18.7   |                                     |
| `pgstream`          | 1.2.2    | 1.2.4    |                                     |
| `postgrest`         | 14.15    | 14.16    |                                     |
| `rainfrog`          | 0.3.20   | 0.4.1    | 次版本更新                               |
| `stalwart`          | 0.16.14  | 0.16.15  |                                     |
| `pig`               | 1.5.1    | 1.6.0    | 尚未发布                                |
| `genai-toolbox`     | 1.7.0    | 1.8.0    | 源码构建 RPM/DEB；已验证 Rocky 8/9、Debian 12 |
| `pg-hardstorage`    | 1.0.16   | 1.0.17   | 直链构建产物更新                            |
| `crush`             | 0.86.0   | 0.87.0   | 直链构建产物更新                            |
{.stretch-last}
