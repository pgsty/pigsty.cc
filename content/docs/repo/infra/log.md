...
| `victoria-traces`          | 0.8.0            | 0.8.1             | 上游升级                             |
| `dblab`                    | 0.37.1           | 0.38.0            | 上游升级                             |
| `grafana-victoriametrics-ds` | 0.23.4         | 0.24.0            | 上游升级                             |
| `grafana-plugins`          | 12.3.0           | 13.0.0            | noarch 插件包，手工归集                |
| `garage`                   | 2.2.0            | 2.3.0             | 上游升级                             |
| `rustfs`                   | 1.0.0-alpha.93   | 1.0.0-alpha.94    | 上游升级                             |
...
| 名称                         | 旧版本          | 新版本            | 备注                         |
|:---------------------------|:---------------|:-----------------|:---------------------------|
| `claude`                   | 2.1.101        | 2.1.107          | 已于 2026-04-14 重新构建         |
| `codex`                    | 0.121.0-alpha.2 | 0.121.0-alpha.7 | 预发布链升级，已于 2026-04-14 重新构建 |
| `agentsview`               | 0.19.0         | 0.22.2           | 上游升级                       |
| `prometheus`               | 3.11.1         | 3.11.2           | 上游升级                       |
| `victoria-metrics`         | 1.139.0        | 1.140.0          | 主包                         |
| `victoria-metrics-cluster` | 1.139.0        | 1.140.0          | VictoriaMetrics 配套组件       |
| `vmutils`                  | 1.139.0        | 1.140.0          | VictoriaMetrics 配套组件       |
| `duckdb`                   | 1.5.1          | 1.5.2            | 上游 bugfix 版本               |
| `seaweedfs`                | 4.19           | 4.20             | 上游升级                       |
| `tigerbeetle`              | 0.16.78        | 0.17.0           | 上游升级                       |
| `maddy`                    | 0.9.2          | 0.9.3            | 上游升级                       |
| `grafana`                  | 12.4.2         | 13.0.0           | 直链元数据更新，主版本升级           |
| `crush`                    | 0.56.0         | 0.57.0           | 直链元数据更新                    |
...
| 名称          | 旧版本              | 新版本             | 备注                                    |
|:--------------|:--------------------|:-------------------|:----------------------------------------|
| `claude`      | 2.1.98              | 2.1.101            | 已于 2026-04-12 重新构建，并改为从版本化 bucket 下载 |
| `codex`       | 0.119.0-alpha.29    | 0.121.0-alpha.2    | 预发布链升级，已于 2026-04-12 重新构建               |
| `postgrest`   | 14.8                | 14.9               | 上游升级                                |
| `rainfrog`    | 0.3.17              | 0.3.18             | 上游升级                                |
| `rustfs`      | 1.0.0-alpha.91      | 1.0.0-alpha.93     | 上游升级，并改为使用带版本号的发布资产名               |
{.stretch-last}
...
| 名称                         | 旧版本            | 新版本              | 备注                         |
|:---------------------------|:---------------|:-----------------|:---------------------------|
| `prometheus`               | 3.10.0         | 3.11.1           | 上游升级                       |
| `alertmanager`             | 0.31.1         | 0.32.0           | 上游升级                       |
| `node_exporter`            | 1.10.2         | 1.11.1           | 上游升级                       |
| `mongodb_exporter`         | 0.49.0         | 0.50.0           | 上游升级                       |
| `victoria-metrics`         | 1.138.0        | 1.139.0          | 主包                         |
| `victoria-metrics-cluster` | 1.138.0        | 1.139.0          | VictoriaMetrics 配套组件       |
| `vmutils`                  | 1.138.0        | 1.139.0          | VictoriaMetrics 配套组件       |
| `victoria-logs`            | 1.48.0         | 1.49.0           | 主包                         |
| `vlagent`                  | 1.48.0         | 1.49.0           | VictoriaLogs 配套组件          |
| `vlogscli`                 | 1.48.0         | 1.49.0           | VictoriaLogs 配套组件          |
| `grafana`                  | 12.4.1         | 12.4.2           | 直链元数据更新                    |
| `duckdb`                   | 1.5.0          | 1.5.1            | 上游升级                       |
| `dblab`                    | 0.34.3         | 0.37.1           | 上游升级                       |
| `grafana-victoriametrics-ds` | 0.23.1       | 0.23.4           | 上游升级                       |
| `grafana-infinity-ds`      | 3.7.4          | 3.8.0            | 上游升级                       |
| `seaweedfs`                | 4.17           | 4.19             | 上游升级                       |
| `rustfs`                   | 1.0.0-alpha.89 | 1.0.0-alpha.91   | 上游升级                       |
| `v2ray`                    | 5.47.0         | 5.48.0           | v2ray-core 软件包             |
| `xray`                     | 26.2.6         | 26.3.27          | 上游升级                       |
| `agentsview`               | 0.15.0         | 0.19.0           | 上游升级                       |
| `claude`                   | 2.1.81         | 2.1.98           | 已于 2026-04-10 重新构建         |
| `codex`                    | 0.116.0        | 0.119.0-alpha.29 | 预发布链升级，已于 2026-04-10 重新构建  |
| `maddy`                    | 0.8.2          | 0.9.2            | 上游升级                       |
| `genai-toolbox`            | 0.27.0         | 1.0.0            | 仅元数据更新，上游已更名为 mcp-toolbox  |
| `npgsqlrest`               | 3.11.1         | 3.12.0           | 上游升级                       |
| `postgrest`                | 14.7           | 14.8             | 上游升级                       |
| `sqlcmd`                   | 1.9.0          | 1.10.0           | 上游升级                       |
| `opencode`                 | 1.2.27         | 1.4.3            | 已于 2026-04-10 重新构建         |
| `uv`                       | 0.10.12        | 0.11.6           | 上游升级                       |
| `golang`                   | 1.26.1         | 1.26.2           | Go 官方稳定版                   |
| `nodejs`                   | 24.14.0        | 24.14.1          | 按 24.x 策略线升级               |
| `pgschema`                 | 1.7.4          | 1.9.0            | 直链元数据更新                    |
| `crush`                    | 0.51.2         | 0.56.0           | 直链元数据更新                    |
| `rclone`                   | 1.73.2         | 1.73.4           | 直链元数据更新                    |
| `code`                     | 1.112.0        | 1.115.0          | VS Code stable 元数据         |
| `code-server`              | 4.112.0        | 4.115.0          | 直链元数据更新                    |
| `tigerbeetle`              | 0.16.77        | 0.16.78          | 上游升级                       |
| `tigerfs`                  | 0.5.0          | 0.6.0            | 上游升级                       |
| `sabiql`                   | 1.8.2          | 1.10.0           | 上游升级                       |
| `hugo`                     | 0.158.0        | 0.160.1          | 上游升级                       |
| `etcd`                     | 3.6.9          | 3.6.8            | 按要求冻结在 3.6.8，并修正 README 显示 |
