...
| 名称                                                                                       | 版本       | 许可证                                                                                    | 备注                   |
|------------------------------------------------------------------------------------------|----------|----------------------------------------------------------------------------------------|----------------------|
| [`grafana`](https://github.com/grafana/grafana/)                                         | `12.4.2` | [AGPLv3](https://github.com/grafana/grafana/blob/main/LICENSE)                         | 开源可观测性与数据可视化平台       |
...
| 名称                                                                                                      | 版本        | 许可证                                                                                           | 备注                          |
|---------------------------------------------------------------------------------------------------------|-----------|-----------------------------------------------------------------------------------------------|-----------------------------|
| [`victoria-metrics`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                | `1.139.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | 高性能时序数据库，替代 Prometheus      |
| [`victoria-logs`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                   | `1.49.0`  | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | 高性能日志存储与查询引擎                |
...
| [`victoria-metrics-cluster`](https://github.com/VictoriaMetrics/VictoriaMetrics)                        | `1.139.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaMetrics 分布式集群版      |
| [`vmutils`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                         | `1.139.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaMetrics 配套命令行工具     |
| [`vlogscli`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                        | `1.49.0`  | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaLogs 交互式查询客户端       |
| [`vlagent`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                         | `1.49.0`  | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaLogs 日志采集代理         |
...
| [`grafana-victoriametrics-ds`](https://github.com/VictoriaMetrics/victoriametrics-datasource/releases/) | `0.23.4`  | [Apache-2.0](https://github.com/VictoriaMetrics/victoriametrics-datasource/blob/main/LICENSE) | VictoriaMetrics Grafana 数据源 |
{.stretch-last}
...
| 名称                                                                     | 版本       | 许可证                                                                               | 备注            |
|------------------------------------------------------------------------|----------|-----------------------------------------------------------------------------------|---------------|
| [`prometheus`](https://github.com/prometheus/prometheus)               | `3.11.1` | [Apache-2.0](https://github.com/prometheus/prometheus/blob/main/LICENSE)          | 云原生监控系统与时序数据库 |
...
| 名称                                                      | 版本               | 许可证                                                                             | 备注                       |
|---------------------------------------------------------|------------------|---------------------------------------------------------------------------------|--------------------------|
| [`minio`](https://github.com/pgsty/minio)               | `20260325000000` | [AGPLv3](https://github.com/minio/minio/blob/master/LICENSE)                    | 开源 S3 服务器，现在由 pgsty 维护构建 |
...
| [`rustfs`](https://github.com/rustfs/rustfs)            | `1.0.0-alpha.91`       | [Apache-2.0](https://github.com/rustfs/rustfs/blob/main/LICENSE)                | 开源 MinIO，Alpha           |
...
| [`seaweedfs`](https://github.com/seaweedfs/seaweedfs)   | `4.19`           | [Apache-2.0](https://github.com/seaweedfs/seaweedfs/blob/master/LICENSE)        | 小文件 S3                   |
...
| [`duckdb`](https://github.com/duckdb/duckdb)                | `1.5.1`   | [MIT](https://github.com/duckdb/duckdb/blob/main/LICENSE)                            | 嵌入式 OLAP                       |
...
| [`tigerbeetle`](https://github.com/tigerbeetle/tigerbeetle) | `0.16.78` | [Apache-2.0](https://github.com/tigerbeetle/tigerbeetle/blob/main/LICENSE)           | 金融 OLTP                        |
...
| [`dblab`](https://github.com/danvergara/dblab)                                          | `0.37.1`   | [MIT](https://github.com/danvergara/dblab/blob/main/LICENSE)                            | 多数据库命令行工具                     |
...
| [`sabiql`](https://github.com/riii111/sabiql)                                           | `1.10.0`    | [MIT](https://github.com/riii111/sabiql/blob/main/LICENSE)                              | 现代化 SQL 客户端（PostgreSQL/MySQL） |
| [`postgrest`](https://github.com/PostgREST/postgrest)                                   | `14.8`     | [MIT](https://github.com/PostgREST/postgrest/blob/main/LICENSE)                         | PostgreSQL RESTful API 服务器    |
...
| [`maddy`](https://github.com/foxcpp/maddy)                                              | `0.9.2`    | [GPL-3.0](https://github.com/foxcpp/maddy/blob/master/LICENSE)                          | 轻量化邮件服务器                      |
{.stretch-last}
...
| 名称                                                             | 版本        | 许可证                                                                         | 备注                             |
|----------------------------------------------------------------|-----------|-----------------------------------------------------------------------------|--------------------------------|
| [`claude`](https://github.com/anthropics/claude-code)          | `2.1.97`  | [Proprietary](https://www.anthropic.com/legal/terms)                        | Claude Code - Anthropic 代理编程工具 |
| [`opencode`](https://github.com/opencode-ai/opencode)          | `1.4.0`  | [MIT](https://github.com/opencode-ai/opencode/blob/main/LICENSE)            | 终端 AI 编程助手                     |
| [`codex`](https://github.com/openai/codex)                     | `0.119.0-alpha.27` | [Apache-2.0](https://github.com/openai/codex/blob/main/LICENSE)             | OpenAI 代理编程工具                  |
| [`crush`](https://github.com/charmbracelet/crush)              | `0.56.0`  | [FSL-1.1-MIT](https://github.com/charmbracelet/crush/blob/main/LICENSE.md)  | Charm 出品的终端 AI 代理编程助手          |
| [`agentsview`](https://github.com/wesm/agentsview)             | `0.19.0`  | [MIT](https://github.com/wesm/agentsview/blob/main/LICENSE)                 | 在终端中浏览与回放 AI 编码代理轨迹            |
...
| [`genai-toolbox`](https://github.com/googleapis/genai-toolbox) | `0.30.0`  | [Apache-2.0](https://github.com/googleapis/genai-toolbox/blob/main/LICENSE) | Google 数据库 MCP 服务器             |
| [`uv`](https://github.com/astral-sh/uv)                        | `0.11.5` | [MIT](https://github.com/astral-sh/uv/blob/main/LICENSE-MIT)                | 新一代 Python 包管理器                |
| [`golang`](https://golang.org/)                                | `1.26.2`  | [BSD-3](https://github.com/golang/go/blob/master/LICENSE)                   | Go 编译器                         |
| [`nodejs`](https://nodejs.org/)                                | `24.14.1` | [MIT/Mixed](https://github.com/nodejs/node/blob/main/LICENSE)               | 在服务端运行 Javascript              |
{.stretch-last}
