...
| 名称                                                                                                      | 版本        | 许可证                                                                                           | 备注                          |
|---------------------------------------------------------------------------------------------------------|-----------|-----------------------------------------------------------------------------------------------|-----------------------------|
| [`victoria-metrics`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                | `1.145.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | 高性能时序数据库，替代 Prometheus      |
...
| [`victoria-traces`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                 | `0.9.2`   | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | 分布式链路追踪后端                   |
| [`victoria-metrics-cluster`](https://github.com/VictoriaMetrics/VictoriaMetrics)                        | `1.145.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaMetrics 分布式集群版      |
| [`vmutils`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                         | `1.145.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaMetrics 配套命令行工具     |
...
| [`grafana-victorialogs-ds`](https://github.com/VictoriaMetrics/victorialogs-datasource/releases/)       | `0.28.0`  | [Apache-2.0](https://github.com/VictoriaMetrics/victorialogs-datasource/blob/main/LICENSE)    | VictoriaLogs Grafana 数据源    |
...
| [`alertmanager`](https://github.com/prometheus/alertmanager)           | `0.32.2` | [Apache-2.0](https://github.com/prometheus/alertmanager/blob/main/LICENSE)        | 告警管理与通知分发     |
...
| [`seaweedfs`](https://github.com/seaweedfs/seaweedfs)   | `4.32`           | [Apache-2.0](https://github.com/seaweedfs/seaweedfs/blob/master/LICENSE)        | 小文件 S3                   |
...
| [`kafka`](https://github.com/apache/kafka)                  | `4.3.0`  | [Apache-2.0](https://github.com/apache/kafka/blob/trunk/LICENSE)                   | 消息队列                        |
| [`duckdb`](https://github.com/duckdb/duckdb)                | `1.5.3`  | [MIT](https://github.com/duckdb/duckdb/blob/main/LICENSE)                          | 嵌入式 OLAP                    |
...
| [`tigerbeetle`](https://github.com/tigerbeetle/tigerbeetle) | `0.17.6` | [Apache-2.0](https://github.com/tigerbeetle/tigerbeetle/blob/main/LICENSE)         | 金融 OLTP                     |
...
| [`pgschema`](https://github.com/pgplex/pgschema)                                        | `1.11.0`   | [Apache-2.0](https://github.com/pgplex/pgschema/blob/main/LICENSE)                      | Terraform 风格的声明式 PG 模式迁移 CLI  |
| [`pgstream`](https://github.com/xataio/pgstream)                                        | `1.0.3`    | [Apache-2.0](https://github.com/xataio/pgstream/blob/main/LICENSE)                      | PostgreSQL 复制与 DDL 变更同步       |
...
| [`dblab`](https://github.com/danvergara/dblab)                                          | `0.40.1`   | [MIT](https://github.com/danvergara/dblab/blob/main/LICENSE)                            | 多数据库命令行工具                     |
...
| [`sabiql`](https://github.com/riii111/sabiql)                                           | `1.12.3`   | [MIT](https://github.com/riii111/sabiql/blob/main/LICENSE)                              | 现代化 SQL 客户端（PostgreSQL/MySQL） |
...
| [`npgsqlrest`](https://github.com/vb-consulting/NpgsqlRest)                             | `3.16.3`   | [MIT](https://github.com/vb-consulting/NpgsqlRest/blob/master/LICENSE.md)               | .NET PostgreSQL REST API 生成器  |
...
| [`hugo`](https://github.com/gohugoio/hugo)                                              | `0.163.0`  | [Apache-2.0](https://github.com/gohugoio/hugo/blob/master/LICENSE)                      | 快速静态网站生成器                     |
| [`cloudflared`](https://github.com/cloudflare/cloudflared)                              | `2026.6.0` | [Apache-2.0](https://github.com/cloudflare/cloudflared/blob/master/LICENSE)             | Cloudflare 隧道客户端              |
...
| [`stalwart`](https://github.com/stalwartlabs/stalwart)                                  | `0.16.8`   | [AGPLv3](https://github.com/stalwartlabs/stalwart/blob/main/LICENSE)                    | 新一代全功能邮件服务器                   |
...
| 名称                                                             | 版本        | 许可证                                                                         | 备注                             |
|----------------------------------------------------------------|-----------|-----------------------------------------------------------------------------|--------------------------------|
| [`claude`](https://github.com/anthropics/claude-code)          | `2.1.172` | [Proprietary](https://www.anthropic.com/legal/terms)                        | Claude Code - Anthropic 代理编程工具 |
| [`opencode`](https://github.com/anomalyco/opencode)            | `1.17.3`  | [MIT](https://github.com/anomalyco/opencode/blob/main/LICENSE)              | 终端 AI 编程助手                     |
| [`codex`](https://github.com/openai/codex)                     | `0.139.0` | [Apache-2.0](https://github.com/openai/codex/blob/main/LICENSE)             | OpenAI 代理编程工具                  |
| [`crush`](https://github.com/charmbracelet/crush)              | `0.76.0`  | [FSL-1.1-MIT](https://github.com/charmbracelet/crush/blob/main/LICENSE.md)  | Charm 出品的终端 AI 代理编程助手          |
| [`agentsview`](https://github.com/kenn-io/agentsview)          | `0.32.1`  | [MIT](https://github.com/kenn-io/agentsview/blob/main/LICENSE)              | 在终端中浏览与回放 AI 编码代理轨迹            |
| [`code`](https://code.visualstudio.com/)                       | `1.124.0` | [MIT](https://github.com/microsoft/vscode/blob/main/LICENSE.txt)            | Visual Studio Code 编辑器         |
| [`code-server`](https://github.com/coder/code-server)          | `4.123.0` | [MIT](https://github.com/coder/code-server/blob/main/LICENSE)               | 浏览器中的 VS Code                  |
...
| [`uv`](https://github.com/astral-sh/uv)                        | `0.11.20` | [MIT](https://github.com/astral-sh/uv/blob/main/LICENSE-MIT)                | 新一代 Python 包管理器                |
| [`golang`](https://golang.org/)                                | `1.26.4`  | [BSD-3](https://github.com/golang/go/blob/master/LICENSE)                   | Go 编译器                         |
| [`nodejs`](https://nodejs.org/)                                | `24.16.0` | [MIT/Mixed](https://github.com/nodejs/node/blob/main/LICENSE)               | 在服务端运行 Javascript              |
{.stretch-last}
