...
| 名称                                                                                       | 版本       | 许可证                                                                                    | 备注                   |
|------------------------------------------------------------------------------------------|----------|----------------------------------------------------------------------------------------|----------------------|
| [`grafana`](https://github.com/grafana/grafana/)                                         | `12.4.1` | [AGPLv3](https://github.com/grafana/grafana/blob/main/LICENSE)                         | 开源可观测性与数据可视化平台       |
...
| [`grafana-infinity-ds`](https://github.com/grafana/grafana-infinity-datasource/)         | `3.7.4`  | [Apache-2.0](https://github.com/grafana/grafana-infinity-datasource/blob/main/LICENSE) | 支持 JSON/CSV/XML 等数据源 |
...
| 名称                                                                                                      | 版本        | 许可证                                                                                           | 备注                          |
|---------------------------------------------------------------------------------------------------------|-----------|-----------------------------------------------------------------------------------------------|-----------------------------|
| [`victoria-metrics`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                | `1.138.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | 高性能时序数据库，替代 Prometheus      |
| [`victoria-logs`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                   | `1.48.0`  | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | 高性能日志存储与查询引擎                |
| [`victoria-traces`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                 | `0.8.0`   | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | 分布式链路追踪后端                   |
| [`victoria-metrics-cluster`](https://github.com/VictoriaMetrics/VictoriaMetrics)                        | `1.138.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaMetrics 分布式集群版      |
| [`vmutils`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                         | `1.138.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaMetrics 配套命令行工具     |
| [`vlogscli`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                        | `1.48.0`  | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaLogs 交互式查询客户端       |
| [`vlagent`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                         | `1.48.0`  | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaLogs 日志采集代理         |
...
| [`grafana-victoriametrics-ds`](https://github.com/VictoriaMetrics/victoriametrics-datasource/releases/) | `0.23.1`  | [Apache-2.0](https://github.com/VictoriaMetrics/victoriametrics-datasource/blob/main/LICENSE) | VictoriaMetrics Grafana 数据源 |
{.stretch-last}
...
| 名称                                                                     | 版本       | 许可证                                                                               | 备注            |
|------------------------------------------------------------------------|----------|-----------------------------------------------------------------------------------|---------------|
| [`prometheus`](https://github.com/prometheus/prometheus)               | `3.10.0` | [Apache-2.0](https://github.com/prometheus/prometheus/blob/main/LICENSE)          | 云原生监控系统与时序数据库 |
...
| [`mongodb_exporter`](https://github.com/percona/mongodb_exporter)         | `0.49.0` | [Apache-2.0](https://github.com/percona/mongodb_exporter/blob/main/LICENSE)           | 导出 mongodb 指标        |
...
| 名称                                                      | 版本               | 许可证                                                                             | 备注                       |
|---------------------------------------------------------|------------------|---------------------------------------------------------------------------------|--------------------------|
| [`minio`](https://github.com/pgsty/minio)               | `20260321000000` | [AGPLv3](https://github.com/minio/minio/blob/master/LICENSE)                    | 开源 S3 服务器，现在由 pgsty 维护构建 |
| [`mcli`](https://github.com/pgsty/mc)                   | `20260321000000` | [AGPLv3](https://github.com/pgsty/mc/blob/main/LICENSE)                         | 开源 S3 客户端，现在由 pgsty 维护构建 |
| [`rustfs`](https://github.com/rustfs/rustfs)            | `alpha.89`       | [Apache-2.0](https://github.com/rustfs/rustfs/blob/main/LICENSE)                | 开源 MinIO，Alpha           |
| [`garage`](https://git.deuxfleurs.fr/Deuxfleurs/garage) | `2.2.0`          | [AGPL-3.0](https://git.deuxfleurs.fr/Deuxfleurs/garage/src/branch/main/LICENSE) | 轻量级 S3                   |
| [`seaweedfs`](https://github.com/seaweedfs/seaweedfs)   | `4.17`           | [Apache-2.0](https://github.com/seaweedfs/seaweedfs/blob/master/LICENSE)        | 小文件 S3                   |
| [`rclone`](https://github.com/rclone/rclone/)           | `1.73.2`         | [MIT](https://github.com/rclone/rclone/blob/master/COPYING)                     | S3 命令行工具                 |
...
| 名称                                                          | 版本        | 许可证                                                                                  | 备注                             |
|-------------------------------------------------------------|-----------|--------------------------------------------------------------------------------------|--------------------------------|
| [`etcd`](https://github.com/etcd-io/etcd)                   | `3.6.8`   | [Apache-2.0](https://github.com/etcd-io/etcd/blob/main/LICENSE)                      | 容错分布式协调服务                      |
...
| [`pgschema`](https://github.com/pgplex/pgschema)                                        | `1.7.4`    | [Apache-2.0](https://github.com/pgplex/pgschema/blob/main/LICENSE)                      | Terraform 风格的声明式 PG 模式迁移 CLI  |
...
| [`tigerfs`](https://github.com/timescale/tigerfs)                                       | `0.5.0`    | [MIT](https://github.com/timescale/tigerfs/blob/main/LICENSE)                           | 将 PostgreSQL 挂载为文件系统          |
| [`dblab`](https://github.com/danvergara/dblab)                                          | `0.34.3`   | [MIT](https://github.com/danvergara/dblab/blob/main/LICENSE)                            | 多数据库命令行工具                     |
| [`rainfrog`](https://github.com/achristmascarl/rainfrog)                                | `0.3.17`   | [MIT](https://github.com/achristmascarl/rainfrog/blob/main/LICENSE)                     | Postgres 终端数据库管理工具            |
...
| [`vray`](https://github.com/v2fly/v2ray-core)                                           | `5.47.0`   | [MIT](https://github.com/v2fly/v2ray-core/blob/master/LICENSE)                          | 构建代理以绕过网络限制                   |
| [`xray`](https://github.com/XTLS/Xray-core)                                             | `26.2.6`   | [MPL-2.0](https://github.com/XTLS/Xray-core/blob/main/LICENSE)                          | 新一代代理核心，支持更强路由与传输协议           |
| [`gost`](https://github.com/ginuerzh/gost)                                              | `2.12.0`   | [MIT](https://github.com/ginuerzh/gost/blob/master/LICENSE)                             | Go 编写的通用隧道与代理工具               |
| [`sabiql`](https://github.com/riii111/sabiql)                                           | `1.8.2`    | [MIT](https://github.com/riii111/sabiql/blob/main/LICENSE)                              | 现代化 SQL 客户端（PostgreSQL/MySQL） |
| [`postgrest`](https://github.com/PostgREST/postgrest)                                   | `14.7`     | [MIT](https://github.com/PostgREST/postgrest/blob/main/LICENSE)                         | PostgreSQL RESTful API 服务器    |
| [`npgsqlrest`](https://github.com/vb-consulting/NpgsqlRest)                             | `3.11.1`   | [MIT](https://github.com/vb-consulting/NpgsqlRest/blob/master/LICENSE.md)               | .NET PostgreSQL REST API 生成器  |
...
| [`hugo`](https://github.com/gohugoio/hugo)                                              | `0.158.0`  | [Apache-2.0](https://github.com/gohugoio/hugo/blob/master/LICENSE)                      | 快速静态网站生成器                     |
...
| 名称                                                             | 版本        | 许可证                                                                         | 备注                             |
|----------------------------------------------------------------|-----------|-----------------------------------------------------------------------------|--------------------------------|
| [`claude`](https://github.com/anthropics/claude-code)          | `2.1.81`  | [Proprietary](https://www.anthropic.com/legal/terms)                        | Claude Code - Anthropic 代理编程工具 |
| [`opencode`](https://github.com/opencode-ai/opencode)          | `1.2.27`  | [MIT](https://github.com/opencode-ai/opencode/blob/main/LICENSE)            | 终端 AI 编程助手                     |
| [`codex`](https://github.com/openai/codex)                     | `0.116.0` | [Apache-2.0](https://github.com/openai/codex/blob/main/LICENSE)             | OpenAI 代理编程工具                  |
| [`crush`](https://github.com/charmbracelet/crush)              | `0.51.2`  | [FSL-1.1-MIT](https://github.com/charmbracelet/crush/blob/main/LICENSE.md)  | Charm 出品的终端 AI 代理编程助手          |
| [`agentsview`](https://github.com/wesm/agentsview)             | `0.15.0`  | [MIT](https://github.com/wesm/agentsview/blob/main/LICENSE)                 | 在终端中浏览与回放 AI 编码代理轨迹            |
| [`code`](https://code.visualstudio.com/)                       | `1.112.0` | [MIT](https://github.com/microsoft/vscode/blob/main/LICENSE.txt)            | Visual Studio Code 编辑器         |
| [`code-server`](https://github.com/coder/code-server)          | `4.112.0` | [MIT](https://github.com/coder/code-server/blob/main/LICENSE)               | 浏览器中的 VS Code                  |
...
| [`uv`](https://github.com/astral-sh/uv)                        | `0.10.12` | [MIT](https://github.com/astral-sh/uv/blob/main/LICENSE-MIT)                | 新一代 Python 包管理器                |
| [`golang`](https://golang.org/)                                | `1.26.1`  | [BSD-3](https://github.com/golang/go/blob/master/LICENSE)                   | Go 编译器                         |
| [`nodejs`](https://nodejs.org/)                                | `24.14.0` | [MIT/Mixed](https://github.com/nodejs/node/blob/main/LICENSE)               | 在服务端运行 Javascript              |
{.stretch-last}
