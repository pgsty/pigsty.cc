---
title: "仓库获取命令（repo-get）"
linkTitle: "repo-get"
weight: 90
description: "pgBackRest `repo-get` 命令选项与行为参考。"
icon: fa-solid fa-file-arrow-down
module: [PGBACKREST]
category: [Reference]
---

> 原始页面： [pgBackRest Command Docs: repo-get](https://pgbackrest.org/command.html#command-repo-get)
