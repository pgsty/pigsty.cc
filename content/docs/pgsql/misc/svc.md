...
每一条服务定义都会在所有相关 HAProxy 实例的配置目录下生成一个新的配置文件：[`/etc/haproxy/<svcname>.cfg`](https://github.com/pgsty/pigsty/blob/main/roles/pgsql/templates/service.j2)
...
- 目的地参数 `dest: default` 意味着Primary服务的目的地受到 [`pg_default_service_dest`](/docs/pgsql/param#pg_default_service_dest) 参数的影响
