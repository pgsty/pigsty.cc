...
扩展是 PostgreSQL 的灵魂所在。Pigsty 收录了 {{< param pgext_count >}} 个预编译、开箱即用的扩展插件，充分释放 PostgreSQL 的潜能。
...
| [**pg_search**](https://github.com/paradedb/paradedb/tree/dev/pg_search) | ParadeDB 搜索扩展，提供 BM25 与全文检索能力   |
...
- [**扩展目录**](/ext/list/)：查阅所有可用扩展的详细信息
- [**扩展仓库**](/ext/repo/)：Pigsty 扩展软件仓库
- [**pig 包管理器**](/ext/pig/)：命令行扩展管理工具
