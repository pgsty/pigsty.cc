...
<details><summary>示例：使用剧本删除用户</summary>
...
<details><summary>示例：手动删除用户</summary>
...
<details><summary>受保护的系统用户</summary>
...
您可以将 crontab 添加到 [`node_crontab`](/docs/node/param#node_crontab) 以指定您的备份策略。
...
要添加新版本的 RPM 包，你需要将它们加入到 [`repo_packages`](/docs/infra/param#repo_packages) 和 [`repo_url_packages`](/docs/infra/param#repo_url_packages) 中。
...
如果你想在 PostgreSQL 集群上安装扩展，请将它们加入到 [`pg_extensions`](/docs/pgsql/param#pg_extensions) 中，并执行：
