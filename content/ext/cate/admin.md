...
| [`pg_rewrite`](/ext/e/pg_rewrite) | [`pg_rewrite`](https://github.com/cybertec-postgresql/pg_rewrite) | `2.2` | <a class="ext-badge ext-badge--license bsd3clause" href="/ext/license#bsd3clause">BSD-3-Clause</a> | <a class="ext-badge ext-badge--lang c" href="/ext/language#c">C</a> | 在线重写整表，不阻塞读写 |
...
| [`pg_squeeze`](/ext/e/pg_squeeze) | [`pg_squeeze`](https://github.com/cybertec-postgresql/pg_squeeze) | `1.9.4` | <a class="ext-badge ext-badge--license bsd2clause" href="/ext/license#bsd2clause">BSD-2-Clause</a> | <a class="ext-badge ext-badge--lang c" href="/ext/language#c">C</a> | 从关系中删除未使用空间 |
...
[**`pg_rewrite`**](/ext/e/pg_rewrite) - `2.2` : 在线重写整表，不阻塞读写
...
[**`pg_squeeze`**](/ext/e/pg_squeeze) - `1.9.4` : 从关系中删除未使用空间
...
[**`pgfincore`**](/ext/e/pgfincore) - `1.4.0` : 检查和管理操作系统缓冲区缓存
...
[**`pg_readonly`**](/ext/e/pg_readonly) - `1.0.6` : 将集群设置为只读
...
[**`pg_permissions`**](/ext/e/pg_permissions) - `1.4.1` : 查看对象权限并将其与期望状态进行比较
...
| **条目** | **属性** | **OS** | **x86_64** | **aarch64** |
|:---:|:---|:---:|:---:|:---:|
| **扩展名** | [`pgautofailover`](/ext/e/pgautofailover) | **el8** | {{< pgvers "18,17,16,15,14" >}} | {{< pgvers "18,17,16,15,14" >}} |
| **扩展包** | [`pgautofailover`](https://github.com/hapostgres/pg_auto_failover) | **el9** | {{< pgvers "18,17,16,15,14" >}} | {{< pgvers "18,17,16,15,14" >}} |
...
[**`pg_pathcheck`**](/ext/e/pg_pathcheck) - `0.9.1` : 校验 planner Path 树，诊断已释放或损坏的内存引用

| **条目** | **属性** | **OS** | **x86_64** | **aarch64** |
|:---:|:---|:---:|:---:|:---:|
| **扩展名** | [`pg_pathcheck`](/ext/e/pg_pathcheck) | **el8** | {{< pgvers "18,17" >}} | {{< pgvers "18,17" >}} |
| **扩展包** | [`pg_pathcheck`](https://github.com/danolivo/pg_pathcheck) | **el9** | {{< pgvers "18,17" >}} | {{< pgvers "18,17" >}} |
...
[**`pgdisablelogerror`**](/ext/e/pgdisablelogerror) - `1.0` : 按 SQLSTATE 错误码禁止部分错误写入 PostgreSQL 服务器日志。

| **条目** | **属性** | **OS** | **x86_64** | **aarch64** |
|:---:|:---|:---:|:---:|:---:|
| **扩展名** | [`pgdisablelogerror`](/ext/e/pgdisablelogerror) | **el8** | {{< pgvers "18,17,16,15,14" >}} | {{< pgvers "18,17,16,15,14" >}} |
| **扩展包** | [`pgdisablelogerror`](https://github.com/fmbiete/pgdisablelogerror) | **el9** | {{< pgvers "18,17,16,15,14" >}} | {{< pgvers "18,17,16,15,14" >}} |
...
[**`online_advisor`**](/ext/e/online_advisor) - `1.0` : 在线建议缺失索引、扩展统计信息与预备语句

| **条目** | **属性** | **OS** | **x86_64** | **aarch64** |
|:---:|:---|:---:|:---:|:---:|
| **扩展名** | [`online_advisor`](/ext/e/online_advisor) | **el8** | {{< pgvers "18,17,16,15,14" >}} | {{< pgvers "18,17,16,15,14" >}} |
| **扩展包** | [`online_advisor`](https://github.com/knizhnik/online_advisor) | **el9** | {{< pgvers "18,17,16,15,14" >}} | {{< pgvers "18,17,16,15,14" >}} |
...
[**`pg_column_tetris`**](/ext/e/pg_column_tetris) - `0.1.0` : 强制采用最优列对齐顺序，以减少 PostgreSQL 行数据中的填充浪费。

| **条目** | **属性** | **OS** | **x86_64** | **aarch64** |
|:---:|:---|:---:|:---:|:---:|
| **扩展名** | [`pg_column_tetris`](/ext/e/pg_column_tetris) | **el8** | {{< pgvers "18,17,16,15,14" >}} | {{< pgvers "18,17,16,15,14" >}} |
| **扩展包** | [`pg_column_tetris`](https://github.com/rogerwelin/pg_column_tetris) | **el9** | {{< pgvers "18,17,16,15,14" >}} | {{< pgvers "18,17,16,15,14" >}} |
...
[**`cat_tools`**](/ext/e/cat_tools) - `0.3.0` : 用于操作 PostgreSQL 系统目录的工具集

| **条目** | **属性** | **OS** | **x86_64** | **aarch64** |
|:---:|:---|:---:|:---:|:---:|
| **扩展名** | [`cat_tools`](/ext/e/cat_tools) | **el8** | {{< pgvers "18,17,16,15,14" >}} | {{< pgvers "18,17,16,15,14" >}} |
| **扩展包** | [`cat_tools`](https://github.com/Postgres-Extensions/cat_tools) | **el9** | {{< pgvers "18,17,16,15,14" >}} | {{< pgvers "18,17,16,15,14" >}} |
...
[**`pgpool`**](/ext/e/pgpool_recovery) - `4.7.2` : PGPool辅助扩展，从v4.3提供的恢复函数
...
[**`pgpool`**](/ext/e/pgpool_regclass) - `4.7.2` : PGPool辅助扩展，RegClass替代
