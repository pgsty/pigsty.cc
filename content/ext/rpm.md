...
在 EL 系统上共有 **561** 个 PostgreSQL 扩展可用，共计 **465** 个扩展包。

其中 **3** 个扩展包是 EL 独有，**1** 个 DEB 扩展包缺少对应的 RPM 包。

| **分类** | **All** | **PGDG** | **PIGSTY** | **CONTRIB** | | **PG18** | **PG17** | **PG16** | **PG15** | **PG14** |
|:--------:|:------:|:--------:|:----------:|:-----------:|:---:|:--------:|:--------:|:--------:|:--------:|:--------:|
| [**EXT**](/ext/rpm) | 561 | 122 | 368 | 71 | | 556 | 542 | 530 | 510 | 487 |
| [**PKG**](/ext/repo) | 465 | 110 | 294 | 0 | | 460 | 451 | 443 | 431 | 412 |
{.ext-table}
...
|:----------|:--------:|:--------:|:---------|:-----------:|:---------|
| [`timescaledb`](/ext/e/timescaledb) | `2.28.3` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `timescaledb-tsl_$v` | {{< pgvers "18,17,16,15" >}} | - |
...
| [`emaj`](/ext/e/emaj) | `5.0.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `emaj_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pg_eviltransform`](/ext/e/pg_eviltransform) | `0.0.4` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pg_eviltransform_$v` | {{< pgvers "18,17,16,15,14" >}} | `postgis36_$v` |
...
| [`pgmnemo`](/ext/e/pgmnemo) | `0.14.2` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pgmnemo_$v` | {{< pgvers "18,17" >}} | `pgvector_$v` |
| [`pgcontext`](/ext/e/pgcontext) | `0.2.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pgcontext_$v` | {{< pgvers "18,17" >}} | - |
{.ext-table}
...
| **扩展包** | **版本** | **仓库** | **包名** | **PG大版本** | **依赖** |
|:----------|:--------:|:--------:|:---------|:-----------:|:---------|
| [`pg_search`](/ext/e/pg_search) | `0.24.3` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pg_search_$v` | {{< pgvers "18,17,16,15" >}} | - |
...
| [`pg_biscuit`](/ext/e/biscuit) | `2.4.3` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `biscuit_$v` | {{< pgvers "18,17,16" >}} | - |
...
| [`pg_pinyin`](/ext/e/pg_pinyin) | `0.0.5` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pg_pinyin_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pg_fts`](/ext/e/pg_fts) | `0.2.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pg_fts_$v` | {{< pgvers "18,17" >}} | - |
...
| [`hunspell`](/ext/e/hunspell_de_de) | `1.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `hunspell_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
| [`hunspell`](/ext/e/hunspell_en_us) | `1.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `hunspell_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
| [`hunspell`](/ext/e/hunspell_fr) | `1.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `hunspell_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
| [`hunspell`](/ext/e/hunspell_ne_np) | `1.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `hunspell_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
| [`hunspell`](/ext/e/hunspell_nl_nl) | `1.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `hunspell_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
| [`hunspell`](/ext/e/hunspell_nn_no) | `1.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `hunspell_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
| [`hunspell`](/ext/e/hunspell_pt_pt) | `1.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `hunspell_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
| [`hunspell`](/ext/e/hunspell_ru_ru) | `1.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `hunspell_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
| [`hunspell`](/ext/e/hunspell_ru_ru_aot) | `1.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `hunspell_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
{.ext-table}
...
| [`pg_lake`](/ext/e/pg_lake) | `3.4.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pg_lake_$v` | {{< pgvers "18,17,16" >}} | - |
{.ext-table}
...
| [`pggraph`](/ext/e/graph) | `1.0.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pggraph_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
| [`pgrdf`](/ext/e/pgrdf) | `0.6.20` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pgrdf_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pg_durable`](/ext/e/pg_durable) | `0.2.3` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pg_durable_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
| [`provsql`](/ext/e/provsql) | `1.11.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `provsql_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`omnigres`](/ext/e/omni) | `20251108` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `omnigres_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
{.ext-table}
...
| [`plpgsql_check`](/ext/e/plpgsql_check) | `2.10.3` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `plpgsql_check_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`plr`](/ext/e/plr) | `8.4.8.6` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `plr_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pgsqlmock`](/ext/e/pgsqlmock) | `1.0.1` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pgsqlmock_$v` | {{< pgvers "18,17,16,15,14" >}} | `pgtap_$v` |
| [`plx`](/ext/e/plx) | `1.3.1` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `plx_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
| [`pgwasm`](/ext/e/pgwasm) | `0.1.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pgwasm_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pgmp`](/ext/e/pgmp) | `1.0.6` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pgmp_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`postbis`](/ext/e/postbis) | `1.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postbis_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pgbson`](/ext/e/pgbson) | `2.0.4` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresbson_$v` | {{< pgvers "18,17,16,15,14" >}} | `libbson` |
...
| [`pg_rewrite`](/ext/e/pg_rewrite) | `2.2` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pg_rewrite_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| **扩展包** | **版本** | **仓库** | **包名** | **PG大版本** | **依赖** |
|:----------|:--------:|:--------:|:---------|:-----------:|:---------|
| [`pg_profile`](/ext/e/pg_profile) | `4.15` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `pg_profile_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pg_flight_recorder`](/ext/e/pgfr_record) | `2.29.2` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pg_flight_recorder_$v` | {{< pgvers "18,17,16,15" >}} | `pg_cron_$v` |
...
| [`pgsentinel`](/ext/e/pgsentinel) | `1.4.2` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pgsentinel_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pg_oidc_validator`](/ext/e/pg_oidc_validator) | `0.2` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pg_oidc_validator_$v` | {{< pgvers "18" >}} | - |
...
| [`pgmemento`](/ext/e/pgmemento) | `0.7.4` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pgmemento_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pgspider_ext`](/ext/e/pgspider_ext) | `1.3.0` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `pgspider_ext_$v` | {{< pgvers "18,17,16,15" >}} | - |
...
| [`db2_fdw`](/ext/e/db2_fdw) | `18.1.2` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `db2_fdw_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
| [`sqlite_fdw`](/ext/e/sqlite_fdw) | `2.5.0` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `sqlite_fdw_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`nominatim_fdw`](/ext/e/nominatim_fdw) | `2.1.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `nominatim_fdw_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| **扩展包** | **版本** | **仓库** | **包名** | **PG大版本** | **依赖** |
|:----------|:--------:|:--------:|:---------|:-----------:|:---------|
| [`documentdb`](/ext/e/documentdb) | `0.114` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `documentdb_$v` | {{< pgvers "18,17,16,15" >}} | `postgresql$v-contrib`, `pg_cron_$v`, `pgvector_$v`, `rum_$v`, `postgis36_$v` |
...
| [`pg_dbms_lock`](/ext/e/pg_dbms_lock) | `2.0` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `pg_dbms_lock_$v` | {{< pgvers "18,17,16,15,14" >}} | `pg_background_$v` |
...
| [`babelfish`](/ext/e/babelfishpg_common) | `6.0.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `babelfish-$v` | {{< pgvers "18,17" >}} | `antlr4-runtime413` |
...
| [`pgmqtt`](/ext/e/pgmqtt) | `0.4.1` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pgmqtt_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
