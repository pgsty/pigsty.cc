...
在 **577** 个已打包扩展总目录中，EL 系统当前覆盖 **576** 个 PostgreSQL 扩展，共计 **468** 个扩展包。
...
| [`plx`](/ext/e/plx) | `2.0.1` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `plx_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`dbt2`](/ext/e/dbt2) | `0.62.0` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `dbt2-pg$v-extensions` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pglite_fusion`](/ext/e/pglite_fusion) | `0.0.7` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pglite_fusion_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pg_currency`](/ext/e/currency) | `0.0.4` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pg_currency_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
| [`pgcollection`](/ext/e/collection) | `2.1.3` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pgcollection_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pguint`](/ext/e/uint) | `1.20260630` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pguint_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| **扩展包** | **版本** | **仓库** | **包名** | **PG大版本** | **依赖** |
|:----------|:--------:|:--------:|:---------|:-----------:|:---------|
| [`pg_gzip`](/ext/e/gzip) | `1.1.1` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `pgsql_gzip_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pg_readme`](/ext/e/pg_readme) | `0.7.1` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `pg_readme_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
| [`ddl_historization`](/ext/e/ddl_historization) | `1.0.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `ddl_historization_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pg_schedoc`](/ext/e/schedoc) | `0.0.2` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pg_schedoc_$v` | {{< pgvers "18,17,16,15,14" >}} | `ddl_historization_$v` |
...
| [`pg_base36`](/ext/e/base36) | `1.1.1` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pg_base36_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pg_accumulator`](/ext/e/pg_accumulator) | `1.2.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pg_accumulator_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pg_stat_log`](/ext/e/pg_stat_log) | `0.2` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `pg_stat_log_$v` | {{< pgvers "18" >}} | - |
...
| [`pg_sqlog`](/ext/e/pg_sqlog) | `1.7` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pg_sqlog_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pgmeminfo`](/ext/e/pgmeminfo) | `1.0.1` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `pgmeminfo_$v` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pg_dbms_errlog`](/ext/e/pg_dbms_errlog) | `2.4` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `pg_dbms_errlog_$v` | {{< pgvers "18,17,16,15,14" >}} | `pg_statement_rollback_$v` |
