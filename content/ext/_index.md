...
description: >
  扩展是 PostgreSQL 的灵魂所在，Pigsty 制作、收录、整合了 555 个 PG 生态扩展，供用户开箱即用。
weight: 20
outputs:
  - HTML
cascade:
...
- [**扩展目录**](/ext/list)：查阅 [**555**](/ext/list) 个扩展插件的详细信息，使用方法，元数据，下载链接与文档
...
- **数量**：无与伦比的扩展数量：**555** 个可用扩展，为 PG 扩展生态之最
...
|:------:|:------:|:------:|:------:|:------:|:---:|:------:|:------:|:------:|:------:|:------:|
| **ALL** | 555 | 162 | 389 | 71 | | 550 | 536 | 526 | 506 | 483 |
| **EL** | 554 | 124 | 359 | 71 | | 549 | 535 | 525 | 505 | 482 |
| **Debian** | 552 | 112 | 369 | 71 | | 547 | 533 | 523 | 503 | 480 |
{.ext-table}
