...
description: >
  扩展是 PostgreSQL 的灵魂所在，Pigsty 制作、打包、收录并整合了 575 个 PG 生态扩展，供用户开箱即用。
weight: 20
outputs:
  - HTML
cascade:
...
- [**已打包扩展目录**](/ext/list)：查阅 [**575 个已打包扩展**](/ext/list) 的详细信息，使用方法，元数据，下载链接与文档
...
- **数量**：无与伦比的扩展数量：**575 个已打包扩展**，为 PG 扩展生态之最
...
|:------:|:------:|:------:|:------:|:------:|:---:|:------:|:------:|:------:|:------:|:------:|
| **ALL** | 575 | 161 | 409 | 71 | | 570 | 556 | 542 | 521 | 499 |
| **EL** | 574 | 123 | 380 | 71 | | 569 | 554 | 541 | 520 | 498 |
| **Debian** | 572 | 112 | 389 | 71 | | 567 | 553 | 539 | 518 | 496 |
{.ext-table}

> **575** 是已打包扩展总目录口径；EL、Debian/Ubuntu 及各 PostgreSQL 大版本行展示对应平台的实际覆盖数，因此可能少于 575。
>
