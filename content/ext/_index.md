...
description: >
  扩展是 PostgreSQL 的灵魂所在，Pigsty 制作、收录、整合了 531 个 PG 生态扩展，供用户开箱即用。
weight: 20
outputs:
  - HTML
cascade:
...
- [**扩展目录**](/ext/list)：查阅 [**531**](/ext/list) 个扩展插件的详细信息，使用方法，元数据，下载链接与文档
...
- **数量**：无与伦比的扩展数量：**531** 个可用扩展，为 PG 扩展生态之最
...
|:------:|:------:|:------:|:------:|:------:|:---:|:------:|:------:|:------:|:------:|:------:|
| **ALL** | 531 | 165 | 346 | 71 | | 515 | 513 | 505 | 494 | 473 |
| **EL** | 526 | 130 | 325 | 71 | | 507 | 508 | 500 | 489 | 468 |
| **Debian** | 518 | 112 | 335 | 71 | | 503 | 501 | 492 | 481 | 460 |
{.ext-table}
...
| <a class="ext-badge ext-badge--cate olap" href="/ext/cate/olap">OLAP</a> | [`citus`](/ext/e/citus)  [`hydra`](/ext/e/columnar)  [`pg_analytics`](/ext/e/pg_analytics)  [`pg_duckdb`](/ext/e/pg_duckdb)  [`pg_mooncake`](/ext/e/pg_mooncake)  [`storage_engine`](/ext/e/storage_engine)  [`pg_clickhouse`](/ext/e/pg_clickhouse)  [`duckdb_fdw`](/ext/e/duckdb_fdw)  [`pg_parquet`](/ext/e/pg_parquet)  [`pg_ducklake`](/ext/e/pg_ducklake)  [`pg_fkpart`](/ext/e/pg_fkpart)  [`pg_partman`](/ext/e/pg_partman)  [`plproxy`](/ext/e/plproxy)  [`pg_strom`](/ext/e/pg_strom)  [`pg_orca`](/ext/e/pg_orca)  [`pg_sorted_heap`](/ext/e/pg_sorted_heap) |
...
| <a class="ext-badge ext-badge--cate lang" href="/ext/cate/lang">LANG</a> | [`pg_tle`](/ext/e/pg_tle)  [`plv8`](/ext/e/plv8)  [`pljs`](/ext/e/pljs)  [`pllua`](/ext/e/pllua)  [`plprql`](/ext/e/plprql)  [`pldebugger`](/ext/e/pldbgapi)  [`plpgsql_check`](/ext/e/plpgsql_check)  [`plprofiler`](/ext/e/plprofiler)  [`plsh`](/ext/e/plsh)  [`pljava`](/ext/e/pljava)  [`plr`](/ext/e/plr)  [`plxslt`](/ext/e/plxslt)  [`pg_mockable`](/ext/e/pg_mockable)  [`pgtap`](/ext/e/pgtap)  [`faker`](/ext/e/faker)  [`dbt2`](/ext/e/dbt2)  [`pg_regresql`](/ext/e/pg_regresql) |
