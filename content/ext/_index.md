...
description: >
  扩展是 PostgreSQL 的灵魂所在，Pigsty 制作、打包、收录并整合了 572 个 PG 生态扩展，供用户开箱即用。
weight: 20
outputs:
  - HTML
cascade:
...
- [**已打包扩展目录**](/ext/list)：查阅 [**572 个已打包扩展**](/ext/list) 的详细信息，使用方法，元数据，下载链接与文档
...
- **数量**：无与伦比的扩展数量：**572 个已打包扩展**，为 PG 扩展生态之最
...
|:------:|:------:|:------:|:------:|:------:|:---:|:------:|:------:|:------:|:------:|:------:|
| **ALL** | 572 | 160 | 407 | 71 | | 567 | 553 | 539 | 518 | 496 |
| **EL** | 571 | 122 | 378 | 71 | | 566 | 552 | 538 | 517 | 495 |
| **Debian** | 569 | 111 | 387 | 71 | | 564 | 550 | 536 | 515 | 493 |
{.ext-table}
