...
linkTitle: "omni_mimetypes"
description: "Omnigres MIME数据类型"
weight: 2957
---

<div class="ext-cards">
  <a class="ext-card ext-card--repo" href="https://docs.omnigres.org/omni_mimetypes/reference/">
    <div class="ext-card__kicker">仓库</div>
    <div class="ext-card__title">https://docs.omnigres.org/omni_mimetypes/reference/</div>
    <div class="ext-card__desc">https://docs.omnigres.org/omni_mimetypes/reference/</div>
  </a>
...
| **相关扩展** | [`byteamagic`](/ext/e/byteamagic) [`pgpdf`](/ext/e/pgpdf) [`pg_html5_email_address`](/ext/e/pg_html5_email_address) [`external_file`](/ext/e/external_file) [`emailaddr`](/ext/e/emailaddr) [`uri`](/ext/e/uri) |
|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
