...
linkTitle: "omni_cloudevents"
description: "Omnigres CloudEvents 支持"
weight: 2943
---

<div class="ext-cards">
  <a class="ext-card ext-card--repo" href="https://docs.omnigres.org/omni_cloudevents/cloud_events/">
    <div class="ext-card__kicker">仓库</div>
    <div class="ext-card__title">https://docs.omnigres.org/omni_cloudevents/cloud_events/</div>
    <div class="ext-card__desc">https://docs.omnigres.org/omni_cloudevents/cloud_events/</div>
  </a>
...
|:----:|:----:|:----:|:------:|:--------:|:----:|
| [**EXT**](/ext/list#feat) | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `0.1.0` | {{< pgvers "18,17,16,15,14" >}} | `omnigres` | `omni_web` |
...
```sql
CREATE EXTENSION omni_cloudevents CASCADE;  -- 依赖: omni_web
```
