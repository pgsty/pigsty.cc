...
description: "Omnigres 高级模式管理组件"
weight: 2963
---

<div class="ext-cards">
  <a class="ext-card ext-card--repo" href="https://docs.omnigres.org/omni_schema/reference/">
    <div class="ext-card__kicker">仓库</div>
    <div class="ext-card__title">https://docs.omnigres.org/omni_schema/reference/</div>
    <div class="ext-card__desc">https://docs.omnigres.org/omni_schema/reference/</div>
  </a>
...
| **扩展包名** | **版本** | **分类** | **许可证** | **语言** |
|:---------------------------------------------------:|:-------:|:--------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------:|:--------------------------------------------------------------------:|
| [**`omnigres`**](/ext/e/omni) | `0.3.0` | <a class="ext-badge ext-badge--cate feat" href="/ext/cate/feat">FEAT</a> | <a class="ext-badge ext-badge--license apache20" href="/ext/license#apache20">Apache-2.0</a> | <a class="ext-badge ext-badge--lang c" href="/ext/language#c">C</a> |
{.ext-table}
...
| **相关扩展** | [`omni_sql`](/ext/e/omni_sql) [`omni_vfs`](/ext/e/omni_vfs) [`omni_polyfill`](/ext/e/omni_polyfill) [`omni_yaml`](/ext/e/omni_yaml) [`dblink`](/ext/e/dblink) [`postgres_fdw`](/ext/e/postgres_fdw) [`omni_types`](/ext/e/omni_types) [`omni_cloudevents`](/ext/e/omni_cloudevents) |
|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
|:----:|:----:|:----:|:------:|:--------:|:----:|
| [**EXT**](/ext/list#feat) | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `0.3.0` | {{< pgvers "18,17,16,15,14" >}} | `omnigres` | `omni_sql`, `omni_vfs`, `omni_polyfill`, `omni_yaml`, `dblink`, `postgres_fdw`, `omni_types`, `omni_cloudevents` |
| [**RPM**](/ext/rpm#feat) | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `0.3.0` | {{< pgvers "18,17,16,15,14" >}} | `omnigres_$v` | - |
| [**DEB**](/ext/deb#feat) | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `0.3.0` | {{< pgvers "18,17,16,15,14" >}} | `postgresql-$v-omnigres` | - |
{.ext-table}
...
```sql
CREATE EXTENSION omni_schema CASCADE;  -- 依赖: omni_sql, omni_vfs, omni_polyfill, omni_yaml, dblink, postgres_fdw, omni_types, omni_cloudevents
```
