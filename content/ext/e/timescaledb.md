...
<div class="ext-cards">
  ...
  <a class="ext-card ext-card--source" href="https://repo.pigsty.cc/ext/src/timescaledb-2.25.2.tar.gz">
...
| **扩展包名** | **版本** | **分类** | **许可证** | **语言** |
|:---------------------------------------------------:|:-------:|:--------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------:|:--------------------------------------------------------------------:|
| [**`timescaledb`**](/ext/e/timescaledb) | `2.25.2` | <a class="ext-badge ext-badge--cate time" href="/ext/cate/time">TIME</a> | <a class="ext-badge ext-badge--license timescale" href="/ext/license#timescale">Timescale</a> | <a class="ext-badge ext-badge--lang c" href="/ext/language#c">C</a> |
{.ext-table}

|  ID   | **扩展名** | **Bin** | **Lib** | **Load** | **Create** | **Trust** | **Reloc** | **模式** |
|:-----:|:-------------------------------------------------------------------------|:--------------------------------------------:|:---------------------------------------------:|:--------------------------------------------:|:---------------------------------------------:|:--------------------------------------------:|:--------------------------------------------:|:----------|
| 1000  | [**`timescaledb`**](/ext/e/timescaledb) | <span class="ext-flag ext-flag--no">否</span> | <span class="ext-flag ext-flag--yes">是</span> | <span class="ext-flag ext-flag--yes">是</span> | <span class="ext-flag ext-flag--yes">是</span> | <span class="ext-flag ext-flag--no">否</span> | <span class="ext-flag ext-flag--no">否</span> | `timescaledb_information` |
{.ext-table}
...
|:----:|:----:|:----:|:------:|:--------:|:----:|
| [**EXT**](/ext/list#time) | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `2.25.2` | {{< pgvers "18,17,16,15" >}} | `timescaledb` | - |
| [**RPM**](/ext/rpm#time) | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `2.25.2` | {{< pgvers "18,17,16,15" >}} | `timescaledb-tsl_$v` | - |
| [**DEB**](/ext/deb#time) | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `2.25.2` | {{< pgvers "18,17,16,15" >}} | `postgresql-$v-timescaledb-tsl` | - |
{.ext-table}

{{< pgext_matrix >}}
| **OS / PG** | **PG18** | **PG17** | **PG16** | **PG15** | **PG14** |
|:--:|:--:|:--:|:--:|:--:|:--:|
| el8.x86_64 | AVAIL PIGSTY 2.25.2 6 | AVAIL PIGSTY 2.25.2 25 | AVAIL PIGSTY 2.25.2 31 | AVAIL PIGSTY 2.25.2 30 | AVAIL PIGSTY 2.19.3 35 |
| el8.aarch64 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.19.3 1 |
| el9.x86_64 | AVAIL PIGSTY 2.25.2 6 | AVAIL PIGSTY 2.25.2 24 | AVAIL PIGSTY 2.25.2 30 | AVAIL PIGSTY 2.25.2 38 | AVAIL PIGSTY 2.19.3 29 |
| el9.aarch64 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.19.3 1 |
| el10.x86_64 | AVAIL PIGSTY 2.25.2 6 | AVAIL PIGSTY 2.25.2 15 | AVAIL PIGSTY 2.25.2 15 | AVAIL PIGSTY 2.25.2 15 | MISS PIGSTY - 0 |
| el10.aarch64 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | MISS PIGSTY - 0 |
| d12.x86_64 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.19.3 1 |
| d12.aarch64 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.19.3 1 |
| d13.x86_64 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | MISS PIGSTY - 0 |
| d13.aarch64 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | MISS PIGSTY - 0 |
| u22.x86_64 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.19.3 1 |
| u22.aarch64 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.19.3 1 |
| u24.x86_64 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.19.3 1 |
| u24.aarch64 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.25.2 1 | AVAIL PIGSTY 2.19.3 1 |
@ el8.x86_64 18 timescaledb-tsl_18 timescaledb-tsl_18-2.25.2-1PIGSTY.el8.x86_64.rpm pigsty 2.25.2 800.4KiB https://repo.pigsty.cc/yum/pgsql/el8.x86_64/timescaledb-tsl_18-2.25.2-1PIGSTY.el8.x86_64.rpm
...
@ el8.aarch64 18 timescaledb-tsl_18 timescaledb-tsl_18-2.25.2-1PIGSTY.el8.aarch64.rpm pigsty 2.25.2 732.8KiB https://repo.pigsty.cc/yum/pgsql/el8.aarch64/timescaledb-tsl_18-2.25.2-1PIGSTY.el8.aarch64.rpm
@ el9.x86_64 18 timescaledb-tsl_18 timescaledb-tsl_18-2.25.2-1PIGSTY.el9.x86_64.rpm pigsty 2.25.2 722.3KiB https://repo.pigsty.cc/yum/pgsql/el9.x86_64/timescaledb-tsl_18-2.25.2-1PIGSTY.el9.x86_64.rpm
...
@ el9.aarch64 18 timescaledb-tsl_18 timescaledb-tsl_18-2.25.2-1PIGSTY.el9.aarch64.rpm pigsty 2.25.2 692.8KiB https://repo.pigsty.cc/yum/pgsql/el9.aarch64/timescaledb-tsl_18-2.25.2-1PIGSTY.el9.aarch64.rpm
@ el10.x86_64 18 timescaledb-tsl_18 timescaledb-tsl_18-2.25.2-1PIGSTY.el10.x86_64.rpm pigsty 2.25.2 755.4KiB https://repo.pigsty.cc/yum/pgsql/el10.x86_64/timescaledb-tsl_18-2.25.2-1PIGSTY.el10.x86_64.rpm
...
@ el10.aarch64 18 timescaledb-tsl_18 timescaledb-tsl_18-2.25.2-1PIGSTY.el10.aarch64.rpm pigsty 2.25.2 701.2KiB https://repo.pigsty.cc/yum/pgsql/el10.aarch64/timescaledb-tsl_18-2.25.2-1PIGSTY.el10.aarch64.rpm
@ d12.x86_64 18 postgresql-18-timescaledb-tsl postgresql-18-timescaledb-tsl_2.25.2-1PIGSTY~bookworm_amd64.deb pigsty 2.25.2 712.6KiB https://repo.pigsty.cc/apt/pgsql/bookworm/pool/main/t/timescaledb-tsl/postgresql-18-timescaledb-tsl_2.25.2-1PIGSTY~bookworm_amd64.deb
@ d12.aarch64 18 postgresql-18-timescaledb-tsl postgresql-18-timescaledb-tsl_2.25.2-1PIGSTY~bookworm_arm64.deb pigsty 2.25.2 651.9KiB https://repo.pigsty.cc/apt/pgsql/bookworm/pool/main/t/timescaledb-tsl/postgresql-18-timescaledb-tsl_2.25.2-1PIGSTY~bookworm_arm64.deb
@ d13.x86_64 18 postgresql-18-timescaledb-tsl postgresql-18-timescaledb-tsl_2.25.2-1PIGSTY~trixie_amd64.deb pigsty 2.25.2 721.3KiB https://repo.pigsty.cc/apt/pgsql/trixie/pool/main/t/timescaledb-tsl/postgresql-18-timescaledb-tsl_2.25.2-1PIGSTY~trixie_amd64.deb
@ d13.aarch64 18 postgresql-18-timescaledb-tsl postgresql-18-timescaledb-tsl_2.25.2-1PIGSTY~trixie_arm64.deb pigsty 2.25.2 661.3KiB https://repo.pigsty.cc/apt/pgsql/trixie/pool/main/t/timescaledb-tsl/postgresql-18-timescaledb-tsl_2.25.2-1PIGSTY~trixie_arm64.deb
@ u22.x86_64 18 postgresql-18-timescaledb-tsl postgresql-18-timescaledb-tsl_2.25.2-1PIGSTY~jammy_amd64.deb pigsty 2.25.2 770.9KiB https://repo.pigsty.cc/apt/pgsql/jammy/pool/main/t/timescaledb-tsl/postgresql-18-timescaledb-tsl_2.25.2-1PIGSTY~jammy_amd64.deb
@ u22.aarch64 18 postgresql-18-timescaledb-tsl postgresql-18-timescaledb-tsl_2.25.2-1PIGSTY~jammy_arm64.deb pigsty 2.25.2 738.8KiB https://repo.pigsty.cc/apt/pgsql/jammy/pool/main/t/timescaledb-tsl/postgresql-18-timescaledb-tsl_2.25.2-1PIGSTY~jammy_arm64.deb
@ u24.x86_64 18 postgresql-18-timescaledb-tsl postgresql-18-timescaledb-tsl_2.25.2-1PIGSTY~noble_amd64.deb pigsty 2.25.2 759.0KiB https://repo.pigsty.cc/apt/pgsql/noble/pool/main/t/timescaledb-tsl/postgresql-18-timescaledb-tsl_2.25.2-1PIGSTY~noble_amd64.deb
@ u24.aarch64 18 postgresql-18-timescaledb-tsl postgresql-18-timescaledb-tsl_2.25.2-1PIGSTY~noble_arm64.deb pigsty 2.25.2 735.8KiB https://repo.pigsty.cc/apt/pgsql/noble/pool/main/t/timescaledb-tsl/postgresql-18-timescaledb-tsl_2.25.2-1PIGSTY~noble_arm64.deb
@ el8.x86_64 17 timescaledb-tsl_17 timescaledb-tsl_17-2.25.2-1PIGSTY.el8.x86_64.rpm pigsty 2.25.2 799.5KiB https://repo.pigsty.cc/yum/pgsql/el8.x86_64/timescaledb-tsl_17-2.25.2-1PIGSTY.el8.x86_64.rpm
...
@ el8.aarch64 17 timescaledb-tsl_17 timescaledb-tsl_17-2.25.2-1PIGSTY.el8.aarch64.rpm pigsty 2.25.2 732.4KiB https://repo.pigsty.cc/yum/pgsql/el8.aarch64/timescaledb-tsl_17-2.25.2-1PIGSTY.el8.aarch64.rpm
@ el9.x86_64 17 timescaledb-tsl_17 timescaledb-tsl_17-2.25.2-1PIGSTY.el9.x86_64.rpm pigsty 2.25.2 724.0KiB https://repo.pigsty.cc/yum/pgsql/el9.x86_64/timescaledb-tsl_17-2.25.2-1PIGSTY.el9.x86_64.rpm
...
@ el9.aarch64 17 timescaledb-tsl_17 timescaledb-tsl_17-2.25.2-1PIGSTY.el9.aarch64.rpm pigsty 2.25.2 684.7KiB https://repo.pigsty.cc/yum/pgsql/el9.aarch64/timescaledb-tsl_17-2.25.2-1PIGSTY.el9.aarch64.rpm
@ el10.x86_64 17 timescaledb-tsl_17 timescaledb-tsl_17-2.25.2-1PIGSTY.el10.x86_64.rpm pigsty 2.25.2 752.4KiB https://repo.pigsty.cc/yum/pgsql/el10.x86_64/timescaledb-tsl_17-2.25.2-1PIGSTY.el10.x86_64.rpm
...
@ el10.aarch64 17 timescaledb-tsl_17 timescaledb-tsl_17-2.25.2-1PIGSTY.el10.aarch64.rpm pigsty 2.25.2 700.7KiB https://repo.pigsty.cc/yum/pgsql/el10.aarch64/timescaledb-tsl_17-2.25.2-1PIGSTY.el10.aarch64.rpm
@ d12.x86_64 17 postgresql-17-timescaledb-tsl postgresql-17-timescaledb-tsl_2.25.2-1PIGSTY~bookworm_amd64.deb pigsty 2.25.2 710.6KiB https://repo.pigsty.cc/apt/pgsql/bookworm/pool/main/t/timescaledb-tsl/postgresql-17-timescaledb-tsl_2.25.2-1PIGSTY~bookworm_amd64.deb
@ d12.aarch64 17 postgresql-17-timescaledb-tsl postgresql-17-timescaledb-tsl_2.25.2-1PIGSTY~bookworm_arm64.deb pigsty 2.25.2 650.4KiB https://repo.pigsty.cc/apt/pgsql/bookworm/pool/main/t/timescaledb-tsl/postgresql-17-timescaledb-tsl_2.25.2-1PIGSTY~bookworm_arm64.deb
@ d13.x86_64 17 postgresql-17-timescaledb-tsl postgresql-17-timescaledb-tsl_2.25.2-1PIGSTY~trixie_amd64.deb pigsty 2.25.2 718.5KiB https://repo.pigsty.cc/apt/pgsql/trixie/pool/main/t/timescaledb-tsl/postgresql-17-timescaledb-tsl_2.25.2-1PIGSTY~trixie_amd64.deb
@ d13.aarch64 17 postgresql-17-timescaledb-tsl postgresql-17-timescaledb-tsl_2.25.2-1PIGSTY~trixie_arm64.deb pigsty 2.25.2 659.6KiB https://repo.pigsty.cc/apt/pgsql/trixie/pool/main/t/timescaledb-tsl/postgresql-17-timescaledb-tsl_2.25.2-1PIGSTY~trixie_arm64.deb
@ u22.x86_64 17 postgresql-17-timescaledb-tsl postgresql-17-timescaledb-tsl_2.25.2-1PIGSTY~jammy_amd64.deb pigsty 2.25.2 768.6KiB https://repo.pigsty.cc/apt/pgsql/jammy/pool/main/t/timescaledb-tsl/postgresql-17-timescaledb-tsl_2.25.2-1PIGSTY~jammy_amd64.deb
@ u22.aarch64 17 postgresql-17-timescaledb-tsl postgresql-17-timescaledb-tsl_2.25.2-1PIGSTY~jammy_arm64.deb pigsty 2.25.2 735.2KiB https://repo.pigsty.cc/apt/pgsql/jammy/pool/main/t/timescaledb-tsl/postgresql-17-timescaledb-tsl_2.25.2-1PIGSTY~jammy_arm64.deb
@ u24.x86_64 17 postgresql-17-timescaledb-tsl postgresql-17-timescaledb-tsl_2.25.2-1PIGSTY~noble_amd64.deb pigsty 2.25.2 756.0KiB https://repo.pigsty.cc/apt/pgsql/noble/pool/main/t/timescaledb-tsl/postgresql-17-timescaledb-tsl_2.25.2-1PIGSTY~noble_amd64.deb
@ u24.aarch64 17 postgresql-17-timescaledb-tsl postgresql-17-timescaledb-tsl_2.25.2-1PIGSTY~noble_arm64.deb pigsty 2.25.2 731.2KiB https://repo.pigsty.cc/apt/pgsql/noble/pool/main/t/timescaledb-tsl/postgresql-17-timescaledb-tsl_2.25.2-1PIGSTY~noble_arm64.deb
@ el8.x86_64 16 timescaledb-tsl_16 timescaledb-tsl_16-2.25.2-1PIGSTY.el8.x86_64.rpm pigsty 2.25.2 799.5KiB https://repo.pigsty.cc/yum/pgsql/el8.x86_64/timescaledb-tsl_16-2.25.2-1PIGSTY.el8.x86_64.rpm
...
@ el8.aarch64 16 timescaledb-tsl_16 timescaledb-tsl_16-2.25.2-1PIGSTY.el8.aarch64.rpm pigsty 2.25.2 732.3KiB https://repo.pigsty.cc/yum/pgsql/el8.aarch64/timescaledb-tsl_16-2.25.2-1PIGSTY.el8.aarch64.rpm
@ el9.x86_64 16 timescaledb-tsl_16 timescaledb-tsl_16-2.25.2-1PIGSTY.el9.x86_64.rpm pigsty 2.25.2 720.0KiB https://repo.pigsty.cc/yum/pgsql/el9.x86_64/timescaledb-tsl_16-2.25.2-1PIGSTY.el9.x86_64.rpm
...
@ el9.aarch64 16 timescaledb-tsl_16 timescaledb-tsl_16-2.25.2-1PIGSTY.el9.aarch64.rpm pigsty 2.25.2 684.7KiB https://repo.pigsty.cc/yum/pgsql/el9.aarch64/timescaledb-tsl_16-2.25.2-1PIGSTY.el9.aarch64.rpm
@ el10.x86_64 16 timescaledb-tsl_16 timescaledb-tsl_16-2.25.2-1PIGSTY.el10.x86_64.rpm pigsty 2.25.2 752.9KiB https://repo.pigsty.cc/yum/pgsql/el10.x86_64/timescaledb-tsl_16-2.25.2-1PIGSTY.el10.x86_64.rpm
...
@ el10.aarch64 16 timescaledb-tsl_16 timescaledb-tsl_16-2.25.2-1PIGSTY.el10.aarch64.rpm pigsty 2.25.2 701.0KiB https://repo.pigsty.cc/yum/pgsql/el10.aarch64/timescaledb-tsl_16-2.25.2-1PIGSTY.el10.aarch64.rpm
@ d12.x86_64 16 postgresql-16-timescaledb-tsl postgresql-16-timescaledb-tsl_2.25.2-1PIGSTY~bookworm_amd64.deb pigsty 2.25.2 705.5KiB https://repo.pigsty.cc/apt/pgsql/bookworm/pool/main/t/timescaledb-tsl/postgresql-16-timescaledb-tsl_2.25.2-1PIGSTY~bookworm_amd64.deb
@ d12.aarch64 16 postgresql-16-timescaledb-tsl postgresql-16-timescaledb-tsl_2.25.2-1PIGSTY~bookworm_arm64.deb pigsty 2.25.2 643.1KiB https://repo.pigsty.cc/apt/pgsql/bookworm/pool/main/t/timescaledb-tsl/postgresql-16-timescaledb-tsl_2.25.2-1PIGSTY~bookworm_arm64.deb
@ d13.x86_64 16 postgresql-16-timescaledb-tsl postgresql-16-timescaledb-tsl_2.25.2-1PIGSTY~trixie_amd64.deb pigsty 2.25.2 714.1KiB https://repo.pigsty.cc/apt/pgsql/trixie/pool/main/t/timescaledb-tsl/postgresql-16-timescaledb-tsl_2.25.2-1PIGSTY~trixie_amd64.deb
@ d13.aarch64 16 postgresql-16-timescaledb-tsl postgresql-16-timescaledb-tsl_2.25.2-1PIGSTY~trixie_arm64.deb pigsty 2.25.2 653.6KiB https://repo.pigsty.cc/apt/pgsql/trixie/pool/main/t/timescaledb-tsl/postgresql-16-timescaledb-tsl_2.25.2-1PIGSTY~trixie_arm64.deb
@ u22.x86_64 16 postgresql-16-timescaledb-tsl postgresql-16-timescaledb-tsl_2.25.2-1PIGSTY~jammy_amd64.deb pigsty 2.25.2 761.5KiB https://repo.pigsty.cc/apt/pgsql/jammy/pool/main/t/timescaledb-tsl/postgresql-16-timescaledb-tsl_2.25.2-1PIGSTY~jammy_amd64.deb
@ u22.aarch64 16 postgresql-16-timescaledb-tsl postgresql-16-timescaledb-tsl_2.25.2-1PIGSTY~jammy_arm64.deb pigsty 2.25.2 728.7KiB https://repo.pigsty.cc/apt/pgsql/jammy/pool/main/t/timescaledb-tsl/postgresql-16-timescaledb-tsl_2.25.2-1PIGSTY~jammy_arm64.deb
@ u24.x86_64 16 postgresql-16-timescaledb-tsl postgresql-16-timescaledb-tsl_2.25.2-1PIGSTY~noble_amd64.deb pigsty 2.25.2 751.8KiB https://repo.pigsty.cc/apt/pgsql/noble/pool/main/t/timescaledb-tsl/postgresql-16-timescaledb-tsl_2.25.2-1PIGSTY~noble_amd64.deb
@ u24.aarch64 16 postgresql-16-timescaledb-tsl postgresql-16-timescaledb-tsl_2.25.2-1PIGSTY~noble_arm64.deb pigsty 2.25.2 727.9KiB https://repo.pigsty.cc/apt/pgsql/noble/pool/main/t/timescaledb-tsl/postgresql-16-timescaledb-tsl_2.25.2-1PIGSTY~noble_arm64.deb
@ el8.x86_64 15 timescaledb-tsl_15 timescaledb-tsl_15-2.25.2-1PIGSTY.el8.x86_64.rpm pigsty 2.25.2 797.8KiB https://repo.pigsty.cc/yum/pgsql/el8.x86_64/timescaledb-tsl_15-2.25.2-1PIGSTY.el8.x86_64.rpm
...
@ el8.aarch64 15 timescaledb-tsl_15 timescaledb-tsl_15-2.25.2-1PIGSTY.el8.aarch64.rpm pigsty 2.25.2 730.4KiB https://repo.pigsty.cc/yum/pgsql/el8.aarch64/timescaledb-tsl_15-2.25.2-1PIGSTY.el8.aarch64.rpm
@ el9.x86_64 15 timescaledb-tsl_15 timescaledb-tsl_15-2.25.2-1PIGSTY.el9.x86_64.rpm pigsty 2.25.2 722.9KiB https://repo.pigsty.cc/yum/pgsql/el9.x86_64/timescaledb-tsl_15-2.25.2-1PIGSTY.el9.x86_64.rpm
...
@ el9.aarch64 15 timescaledb-tsl_15 timescaledb-tsl_15-2.25.2-1PIGSTY.el9.aarch64.rpm pigsty 2.25.2 686.7KiB https://repo.pigsty.cc/yum/pgsql/el9.aarch64/timescaledb-tsl_15-2.25.2-1PIGSTY.el9.aarch64.rpm
@ el10.x86_64 15 timescaledb-tsl_15 timescaledb-tsl_15-2.25.2-1PIGSTY.el10.x86_64.rpm pigsty 2.25.2 747.4KiB https://repo.pigsty.cc/yum/pgsql/el10.x86_64/timescaledb-tsl_15-2.25.2-1PIGSTY.el10.x86_64.rpm
...
@ el10.aarch64 15 timescaledb-tsl_15 timescaledb-tsl_15-2.25.2-1PIGSTY.el10.aarch64.rpm pigsty 2.25.2 698.7KiB https://repo.pigsty.cc/yum/pgsql/el10.aarch64/timescaledb-tsl_15-2.25.2-1PIGSTY.el10.aarch64.rpm
@ d12.x86_64 15 postgresql-15-timescaledb-tsl postgresql-15-timescaledb-tsl_2.25.2-1PIGSTY~bookworm_amd64.deb pigsty 2.25.2 701.4KiB https://repo.pigsty.cc/apt/pgsql/bookworm/pool/main/t/timescaledb-tsl/postgresql-15-timescaledb-tsl_2.25.2-1PIGSTY~bookworm_amd64.deb
@ d12.aarch64 15 postgresql-15-timescaledb-tsl postgresql-15-timescaledb-tsl_2.25.2-1PIGSTY~bookworm_arm64.deb pigsty 2.25.2 639.1KiB https://repo.pigsty.cc/apt/pgsql/bookworm/pool/main/t/timescaledb-tsl/postgresql-15-timescaledb-tsl_2.25.2-1PIGSTY~bookworm_arm64.deb
@ d13.x86_64 15 postgresql-15-timescaledb-tsl postgresql-15-timescaledb-tsl_2.25.2-1PIGSTY~trixie_amd64.deb pigsty 2.25.2 709.2KiB https://repo.pigsty.cc/apt/pgsql/trixie/pool/main/t/timescaledb-tsl/postgresql-15-timescaledb-tsl_2.25.2-1PIGSTY~trixie_amd64.deb
@ d13.aarch64 15 postgresql-15-timescaledb-tsl postgresql-15-timescaledb-tsl_2.25.2-1PIGSTY~trixie_arm64.deb pigsty 2.25.2 649.6KiB https://repo.pigsty.cc/apt/pgsql/trixie/pool/main/t/timescaledb-tsl/postgresql-15-timescaledb-tsl_2.25.2-1PIGSTY~trixie_arm64.deb
@ u22.x86_64 15 postgresql-15-timescaledb-tsl postgresql-15-timescaledb-tsl_2.25.2-1PIGSTY~jammy_amd64.deb pigsty 2.25.2 759.2KiB https://repo.pigsty.cc/apt/pgsql/jammy/pool/main/t/timescaledb-tsl/postgresql-15-timescaledb-tsl_2.25.2-1PIGSTY~jammy_amd64.deb
@ u22.aarch64 15 postgresql-15-timescaledb-tsl postgresql-15-timescaledb-tsl_2.25.2-1PIGSTY~jammy_arm64.deb pigsty 2.25.2 723.7KiB https://repo.pigsty.cc/apt/pgsql/jammy/pool/main/t/timescaledb-tsl/postgresql-15-timescaledb-tsl_2.25.2-1PIGSTY~jammy_arm64.deb
@ u24.x86_64 15 postgresql-15-timescaledb-tsl postgresql-15-timescaledb-tsl_2.25.2-1PIGSTY~noble_amd64.deb pigsty 2.25.2 747.5KiB https://repo.pigsty.cc/apt/pgsql/noble/pool/main/t/timescaledb-tsl/postgresql-15-timescaledb-tsl_2.25.2-1PIGSTY~noble_amd64.deb
@ u24.aarch64 15 postgresql-15-timescaledb-tsl postgresql-15-timescaledb-tsl_2.25.2-1PIGSTY~noble_arm64.deb pigsty 2.25.2 724.7KiB https://repo.pigsty.cc/apt/pgsql/noble/pool/main/t/timescaledb-tsl/postgresql-15-timescaledb-tsl_2.25.2-1PIGSTY~noble_arm64.deb
