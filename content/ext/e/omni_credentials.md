...
linkTitle: "omni_credentials"
description: "Omnigres 应用密钥管理模块"
weight: 2945
---

<div class="ext-cards">
  <a class="ext-card ext-card--repo" href="https://docs.omnigres.org/omni_credentials/credentials/">
...
| **相关扩展** | [`pgcrypto`](/ext/e/pgcrypto) [`omni_os`](/ext/e/omni_os) |
|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
|:----:|:----:|:----:|:------:|:--------:|:----:|
| [**EXT**](/ext/list#feat) | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `0.2.0` | {{< pgvers "18,17,16,15,14" >}} | `omnigres` | `pgcrypto`, `omni_os` |
...
```sql
CREATE EXTENSION omni_credentials CASCADE;  -- 依赖: pgcrypto, omni_os
```
