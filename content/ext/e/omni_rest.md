...
title: "omni_rest"
linkTitle: "omni_rest"
description: "Omnigres REST API 工具包"
weight: 2962
---

<div class="ext-cards">
  <a class="ext-card ext-card--repo" href="https://docs.omnigres.org/omni_rest/protocols/">
    <div class="ext-card__kicker">仓库</div>
    <div class="ext-card__title">https://docs.omnigres.org/omni_rest/protocols/</div>
    <div class="ext-card__desc">https://docs.omnigres.org/omni_rest/protocols/</div>
  </a>
...
| **扩展包名** | **版本** | **分类** | **许可证** | **语言** |
|:---------------------------------------------------:|:-------:|:--------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------:|:--------------------------------------------------------------------:|
| [**`omnigres`**](/ext/e/omni) | `0.1.1` | <a class="ext-badge ext-badge--cate feat" href="/ext/cate/feat">FEAT</a> | <a class="ext-badge ext-badge--license apache20" href="/ext/license#apache20">Apache-2.0</a> | <a class="ext-badge ext-badge--lang c" href="/ext/language#c">C</a> |
{.ext-table}
...
| **相关扩展** | [`omni_httpd`](/ext/e/omni_httpd) [`omni_sql`](/ext/e/omni_sql) [`omni_web`](/ext/e/omni_web) [`omni_var`](/ext/e/omni_var) [`pgcrypto`](/ext/e/pgcrypto) [`pg_graphql`](/ext/e/pg_graphql) [`http`](/ext/e/http) [`pg_net`](/ext/e/pg_net) [`documentdb`](/ext/e/documentdb) [`pg_curl`](/ext/e/pg_curl) |
|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
|:----:|:----:|:----:|:------:|:--------:|:----:|
| [**EXT**](/ext/list#feat) | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `0.1.1` | {{< pgvers "18,17,16,15,14" >}} | `omnigres` | `omni_httpd`, `omni_sql`, `omni_web`, `omni_var`, `pgcrypto` |
...
```sql
CREATE EXTENSION omni_rest CASCADE;  -- 依赖: omni_httpd, omni_sql, omni_web, omni_var, pgcrypto
```
...
> [omni_rest: REST API 工具箱（支持 PostgREST）](https://docs.omnigres.org/omni_rest/protocols/)

`omni_rest` 扩展提供 REST API 功能，具备基本的 PostgREST 协议兼容性。

该扩展实现了对 PostgREST 协议的基础支持。协议详情请参阅 [PostgREST 文档](https://postgrest.org/)。

这是早期版本；尚未实现所有 PostgREST 功能，优先实现核心用例。依赖 `omni_httpd`。
