---
title: "omni_regex"
linkTitle: "omni_regex"
description: "Omnigres PCRE兼容正则表达式模块"
weight: 2961
---

<div class="ext-cards">
  <a class="ext-card ext-card--repo" href="https://docs.omnigres.org/omni_regex/regex/">
    <div class="ext-card__kicker">仓库</div>
    <div class="ext-card__title">https://docs.omnigres.org/omni_regex/regex/</div>
    <div class="ext-card__desc">https://docs.omnigres.org/omni_regex/regex/</div>
  </a>
...
| **相关扩展** | [`pgpcre`](/ext/e/pgpcre) [`re2`](/ext/e/re2) [`pg_trgm`](/ext/e/pg_trgm) [`pg_similarity`](/ext/e/pg_similarity) [`fuzzystrmatch`](/ext/e/fuzzystrmatch) [`smlar`](/ext/e/smlar) [`biscuit`](/ext/e/biscuit) [`pg_bigm`](/ext/e/pg_bigm) |
|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
