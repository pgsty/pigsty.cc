...
linkTitle: "omni_containers"
description: "Omnigres Docker容器管理模块"
weight: 2944
---

<div class="ext-cards">
  <a class="ext-card ext-card--repo" href="https://docs.omnigres.org/omni_containers/intro/">
    <div class="ext-card__kicker">仓库</div>
    <div class="ext-card__title">https://docs.omnigres.org/omni_containers/intro/</div>
    <div class="ext-card__desc">https://docs.omnigres.org/omni_containers/intro/</div>
  </a>
...
| **相关扩展** | [`omni_httpc`](/ext/e/omni_httpc) [`omni_web`](/ext/e/omni_web) |
|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
|:----:|:----:|:----:|:------:|:--------:|:----:|
| [**EXT**](/ext/list#feat) | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `0.2.0` | {{< pgvers "18,17,16,15,14" >}} | `omnigres` | `omni_httpc`, `omni_web` |
