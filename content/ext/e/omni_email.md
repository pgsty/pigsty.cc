---
title: "omni_email"
linkTitle: "omni_email"
description: "Omnigres Email 框架"
weight: 2948
---

<div class="ext-cards">
  <a class="ext-card ext-card--repo" href="https://docs.omnigres.org/omni_email/reference/">
    <div class="ext-card__kicker">仓库</div>
    <div class="ext-card__title">https://docs.omnigres.org/omni_email/reference/</div>
    <div class="ext-card__desc">https://docs.omnigres.org/omni_email/reference/</div>
  </a>
...
| **相关扩展** | [`omni_id`](/ext/e/omni_id) [`omni_cloudevents`](/ext/e/omni_cloudevents) [`omni_polyfill`](/ext/e/omni_polyfill) [`pg_smtp_client`](/ext/e/pg_smtp_client) [`pg_utl_smtp`](/ext/e/pg_utl_smtp) [`pg_html5_email_address`](/ext/e/pg_html5_email_address) [`emailaddr`](/ext/e/emailaddr) [`uri`](/ext/e/uri) |
|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
|:----:|:----:|:----:|:------:|:--------:|:----:|
| [**EXT**](/ext/list#feat) | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `0.1.0` | {{< pgvers "18,17,16,15,14" >}} | `omnigres` | `omni_id`, `omni_cloudevents`, `omni_polyfill` |
...
```sql
CREATE EXTENSION omni_email CASCADE;  -- 依赖: omni_id, omni_cloudevents, omni_polyfill
```
...
> [omni_email: 电子邮件框架](https://docs.omnigres.org/omni_email/reference/)

`omni_email` 扩展为 PostgreSQL 提供电子邮件框架。依赖 `omni_id`、`omni_cloudevents` 和 `omni_polyfill`。

该扩展提供用于在数据库内编写、存储和管理电子邮件消息的类型和函数，与 Omnigres CloudEvents 系统集成以实现事件驱动的邮件工作流。
