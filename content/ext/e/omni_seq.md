...
title: "omni_seq"
linkTitle: "omni_seq"
description: "Omnigres 分布式整型序列号"
weight: 2964
---

<div class="ext-cards">
  <a class="ext-card ext-card--repo" href="https://docs.omnigres.org/omni_seq/id/">
    <div class="ext-card__kicker">仓库</div>
    <div class="ext-card__title">https://docs.omnigres.org/omni_seq/id/</div>
    <div class="ext-card__desc">https://docs.omnigres.org/omni_seq/id/</div>
  </a>
...
| **相关扩展** | [`snowflake`](/ext/e/snowflake) [`permuteseq`](/ext/e/permuteseq) [`sequential_uuids`](/ext/e/sequential_uuids) [`pg_uuidv7`](/ext/e/pg_uuidv7) [`pg_idkit`](/ext/e/pg_idkit) [`pgx_ulid`](/ext/e/pgx_ulid) [`pg_uuid_v8`](/ext/e/pg_uuid_v8) [`uuid-ossp`](/ext/e/uuid-ossp) [`typeid`](/ext/e/typeid) |
|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
