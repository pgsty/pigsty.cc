...
title: "omni_vfs"
linkTitle: "omni_vfs"
description: "Omnigres 虚拟文件系统"
weight: 2974
---

<div class="ext-cards">
  <a class="ext-card ext-card--repo" href="https://docs.omnigres.org/omni_vfs/reference/">
    <div class="ext-card__kicker">仓库</div>
    <div class="ext-card__title">https://docs.omnigres.org/omni_vfs/reference/</div>
    <div class="ext-card__desc">https://docs.omnigres.org/omni_vfs/reference/</div>
  </a>
...
|:----:|:----:|:----:|:------:|:--------:|:----:|
| [**EXT**](/ext/list#feat) | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `0.2.2` | {{< pgvers "18,17,16,15,14" >}} | `omnigres` | `omni_vfs_types_v1`, `dblink` |
...
```sql
CREATE EXTENSION omni_vfs CASCADE;  -- 依赖: omni_vfs_types_v1, dblink
```
