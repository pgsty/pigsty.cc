...
description: "Omnigres 第一类Python支持模块"
weight: 2960
---

<div class="ext-cards">
  <a class="ext-card ext-card--repo" href="https://docs.omnigres.org/omni_python/intro/">
    <div class="ext-card__kicker">仓库</div>
    <div class="ext-card__title">https://docs.omnigres.org/omni_python/intro/</div>
    <div class="ext-card__desc">https://docs.omnigres.org/omni_python/intro/</div>
  </a>
...
| **相关扩展** | [`plpython3u`](/ext/e/plpython3u) [`plpython3u`](/ext/e/plpython3u) [`faker`](/ext/e/faker) [`multicorn`](/ext/e/multicorn) [`wrappers`](/ext/e/wrappers) [`odbc_fdw`](/ext/e/odbc_fdw) [`jdbc_fdw`](/ext/e/jdbc_fdw) [`dbt2`](/ext/e/dbt2) |
|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
|:----:|:----:|:----:|:------:|:--------:|:----:|
| [**EXT**](/ext/list#feat) | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `0.1.1` | {{< pgvers "18,17,16,15,14" >}} | `omnigres` | `plpython3u` |
...
```sql
CREATE EXTENSION omni_python CASCADE;  -- 依赖: plpython3u
```
