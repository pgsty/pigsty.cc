...
title: "omni_yaml"
linkTitle: "omni_yaml"
description: "Omnigres YAML工具包"
weight: 2979
---

<div class="ext-cards">
  <a class="ext-card ext-card--repo" href="https://docs.omnigres.org/omni_yaml/yaml/">
    <div class="ext-card__kicker">仓库</div>
    <div class="ext-card__title">https://docs.omnigres.org/omni_yaml/yaml/</div>
    <div class="ext-card__desc">https://docs.omnigres.org/omni_yaml/yaml/</div>
  </a>
...
|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **下游依赖** | [`omni_kube`](/ext/e/omni_kube) [`omni_schema`](/ext/e/omni_schema) |
