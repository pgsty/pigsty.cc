...
| **相关扩展** | [`session_variable`](/ext/e/session_variable) [`omni_var`](/ext/e/omni_var) [`pg_fsql`](/ext/e/pg_fsql) [`pg_query_rewrite`](/ext/e/pg_query_rewrite) |
|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **下游依赖** | [`pgelog`](/ext/e/pgelog) |
