...
| **相关扩展** | [`basic_archive`](/ext/e/basic_archive) [`aws_s3`](/ext/e/aws_s3) [`external_file`](/ext/e/external_file) [`file_fdw`](/ext/e/file_fdw) [`repmgr`](/ext/e/repmgr) [`pg_parquet`](/ext/e/pg_parquet) [`pg_bulkload`](/ext/e/pg_bulkload) |
|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
