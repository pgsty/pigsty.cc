...
title: "omni_json"
linkTitle: "omni_json"
description: "Omnigres JSON工具箱"
weight: 2953
---

<div class="ext-cards">
  <a class="ext-card ext-card--repo" href="https://docs.omnigres.org/omni_json/table_mapping/">
    <div class="ext-card__kicker">仓库</div>
    <div class="ext-card__title">https://docs.omnigres.org/omni_json/table_mapping/</div>
    <div class="ext-card__desc">https://docs.omnigres.org/omni_json/table_mapping/</div>
  </a>
...
| **相关扩展** | [`pgjq`](/ext/e/pgjq) [`pg_jsonschema`](/ext/e/pg_jsonschema) [`jsonschema`](/ext/e/jsonschema) [`pgbson`](/ext/e/pgbson) [`jsquery`](/ext/e/jsquery) [`pg_projection`](/ext/e/pg_projection) |
|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
