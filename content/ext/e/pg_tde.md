...
<div class="ext-cards">
  ...
  <a class="ext-card ext-card--source" href="https://repo.pigsty.cc/ext/src/percona-pg_tde18-2.2.2.tar.gz">
...
您可以使用 `pig build` 命令构建 `pg_tde` 扩展的 RPM / DEB 包：

```bash
pig build pkg pg_tde         # 构建 RPM / DEB 包
```
