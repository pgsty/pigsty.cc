...
在 Debian/Ubuntu 系统上共有 **518** 个 PostgreSQL 扩展可用，共计 **432** 个扩展包。

其中 **2** 个扩展包是 Debian/Ubuntu 独有，**13** 个 RPM 扩展包缺少对应的 DEB 包。

| **分类** | **All** | **PGDG** | **PIGSTY** | **CONTRIB** | | **PG18** | **PG17** | **PG16** | **PG15** | **PG14** |
|:--------:|:------:|:--------:|:----------:|:-----------:|:---:|:--------:|:--------:|:--------:|:--------:|:--------:|
| [**EXT**](/ext/deb) | 518 | 112 | 335 | 71 | | 503 | 501 | 492 | 481 | 460 |
| [**PKG**](/ext/repo) | 432 | 97 | 274 | 0 | | 417 | 420 | 414 | 404 | 386 |
{.ext-table}
...
|:----------|:--------:|:--------:|:---------|:-----------:|:---------|
| [`timescaledb`](/ext/e/timescaledb) | `2.28.2` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-timescaledb-tsl` | {{< pgvers "18,17,16,15" >}} | - |
...
| [`q3c`](/ext/e/q3c) | `2.0.3` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `postgresql-$v-q3c` | {{< pgvers "18,17,16,15,14" >}} | - |
| [`ogr_fdw`](/ext/e/ogr_fdw) | `1.1.8` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `postgresql-$v-ogr-fdw` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| **扩展包** | **版本** | **仓库** | **包名** | **PG大版本** | **依赖** |
|:----------|:--------:|:--------:|:---------|:-----------:|:---------|
| [`pgvector`](/ext/e/vector) | `0.8.4` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `postgresql-$v-pgvector` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pgmnemo`](/ext/e/pgmnemo) | `0.12.1` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-pgmnemo` | {{< pgvers "14,15,16,17,18" >}} | `pgvector` |
{.ext-table}
...
| **扩展包** | **版本** | **仓库** | **包名** | **PG大版本** | **依赖** |
|:----------|:--------:|:--------:|:---------|:-----------:|:---------|
| [`pg_search`](/ext/e/pg_search) | `0.24.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-pg-search` | {{< pgvers "18,17,16,15" >}} | - |
...
| [`pg_biscuit`](/ext/e/biscuit) | `2.4.1` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-biscuit` | {{< pgvers "18,17,16" >}} | - |
...
| [`pg_pinyin`](/ext/e/pg_pinyin) | `0.0.4` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-pinyin` | {{< pgvers "18,17,16,15,14" >}} | - |
| [`pg_kazsearch`](/ext/e/pg_kazsearch) | `2.2.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-pg-kazsearch` | {{< pgvers "18,17,16" >}} | - |
...
| **扩展包** | **版本** | **仓库** | **包名** | **PG大版本** | **依赖** |
|:----------|:--------:|:--------:|:---------|:-----------:|:---------|
| [`age`](/ext/e/age) | `1.7.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-age` | {{< pgvers "18,17" >}} | - |
...
| [`pggraph`](/ext/e/graph) | `0.1.7` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-pggraph` | {{< pgvers "14,15,16,17,18" >}} | - |
| [`pgrdf`](/ext/e/pgrdf) | `0.6.4` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-pgrdf` | {{< pgvers "14,15,16,17" >}} | - |
...
| [`hll`](/ext/e/hll) | `2.20` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `postgresql-$v-hll` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`jsonschema`](/ext/e/jsonschema) | `0.1.9` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-jsonschema` | {{< pgvers "14,15,16,17,18" >}} | - |
...
| [`pg_durable`](/ext/e/pg_durable) | `0.2.2` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-pg-durable` | {{< pgvers "14,15,16,17,18" >}} | - |
| [`provsql`](/ext/e/provsql) | `1.10.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-provsql` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`plpgsql_check`](/ext/e/plpgsql_check) | `2.9.2` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `postgresql-$v-plpgsql-check` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pg_http`](/ext/e/http) | `1.7.1` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `postgresql-$v-http` | {{< pgvers "18,17,16,15,14" >}} | - |
| [`pg_net`](/ext/e/pg_net) | `0.20.3` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-pg-net` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`re2`](/ext/e/re2) | `0.4.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-re2` | {{< pgvers "18,17,16" >}} | - |
...
| [`powa`](/ext/e/powa) | `5.1.2` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `postgresql-$v-powa` | {{< pgvers "18,17,16,15,14" >}} | - |
{.ext-table}
...
| [`pgsodium`](/ext/e/pgsodium) | `3.1.9` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `postgresql-$v-pgsodium` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`pg_anon`](/ext/e/anon) | `3.1.1` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-pg-anon` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| **扩展包** | **版本** | **仓库** | **包名** | **PG大版本** | **依赖** |
|:----------|:--------:|:--------:|:---------|:-----------:|:---------|
| [`wrappers`](/ext/e/wrappers) | `0.6.1` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-wrappers` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| **扩展包** | **版本** | **仓库** | **包名** | **PG大版本** | **依赖** |
|:----------|:--------:|:--------:|:---------|:-----------:|:---------|
| [`documentdb`](/ext/e/documentdb) | `0.113` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-documentdb` | {{< pgvers "18,17,16,15" >}} | `postgresql-$v-cron`, `postgresql-$v-pgvector`, `postgresql-$v-rum`, `postgresql-$v-postgis-3` |
...
| [`pgtt`](/ext/e/pgtt) | `4.5` | <a class="ext-badge ext-badge--repo pgdg" href="/ext/repo#pgdg">PGDG</a> | `postgresql-$v-pgtt` | {{< pgvers "18,17,16,15,14" >}} | - |
...
| [`ivorysql`](/ext/e/ivorysql_ora) | `5.4` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `ivorysql-5` | {{< pgvers "18" >}} | - |
...
| [`babelfish`](/ext/e/babelfishpg_common) | `5.4.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `babelfish-$v` | {{< pgvers "18,17" >}} | `libantlr4-runtime413` |
...
| [`pgmqtt`](/ext/e/pgmqtt) | `0.3.0` | <a class="ext-badge ext-badge--repo pigsty" href="/ext/repo#pigsty">PIGSTY</a> | `postgresql-$v-pgmqtt` | {{< pgvers "18,17,16,15,14" >}} | - |
