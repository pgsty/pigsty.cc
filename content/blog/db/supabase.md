...
而通过 Pigsty 自建的 Supabase 则提供了多达 [**531**](/ext/list/) 个开箱即用的 PG 扩展。
...
在这一自建部署架构中，您获得了使用不同内核的自由（PG 15-18，OrioleDB），加装 [**531**](/ext/list/) 个扩展的自由，扩容与伸缩 Supabase / Postgres / MinIO 的自由，
...
经过这些配置，您拥有了一个带公网域名，HTTPS 证书，SMTP，PITR 备份，监控，IaC，以及 531 个扩展的企业级 Supabase （基础单机版）。
